...
* Results
The research goals behind this project are focused on developing and modelling information on wheat domestication. With statistical software created specifically to utilise \micro-CT image data on wheat grains, the five groups highlighted as the initial hypothesis were able to be investigated.
