...
Results were created using the CT Data Analysis Library, example of this is shown in the appendix:[[sec:resultsgen]].

\clearpage
** The effects of Domestication
The groups /T. beoticum/ (2N|W) and /T. monococcum/ (2N|D) show that width is significantly different, a 8.6% chance that the mean of /T. beoticum/ width is greater than /T. monococcum/ is reported. Shown in figure:[[fig:diffmeansvolume]].

The reported change in width for tetraploids /T. dicoccum/ (4N|D) and /T. dicoccoides/ (4N|W) is not significant. A 36.3% chance exists that the means of the groups are different, which is not a strong difference based on our model.

#+ATTR_LATEX: :width 8cm
#+name: fig:diffmeansvolume
#+caption: Difference of means plot for posterior probability of volume in /T. beoticum/ (2N|W) and /T. monococcum/ (2N|D)
[[./images/results/group1/width.png]]
...
For the tetraploid genotypes /T. dicoccum/ and /T. dicoccoides/ the effect of domestication on length appears statistically insignificant. A 27.3% chance is reported as the likelihood of both means being independent. Whilst the data leans towards /T. dicoccum/ having a larger mean, there is insufficient evidence to confidently suggest that there is an effect.
...
** The effects of Polyploidization

Polyploidization, the process by which organisms hybridise into developing extra sets of homologous chromosomes.

Diploids (/T. beoticum/ (2N|W), /T. monococcum/ (2N|D)) , tetraploids (/T. dicoccum/ (4N|D), /T. dicoccoides/ (2N|D)) show a significant difference in volume.
...
Further examination of domesticated diploids (/T. monococcum/) and domesticated tetraploids (/T. dicoccum/) has shown that there is no significant differences in length, width or depth (figure:\ref{fig:widthdpethlength})
...
However, a significant difference is seen in volume (figure:[[fig:ploidyvolmono]]) which can be seen as a culmination of the three geometric descriptors. This indicates that better and more complex descriptors may be required to fully decipher these differences in grains.

\clearpage

#+CAPTION: A boxplot of /T. monococcum/ and /T. dicoccodies/ volume
#+NAME: fig:ploidyvolmono
#+ATTR_LATEX: :width 8cm
[[./images/results/group8/volume.png]]
...
#+CAPTION: A boxplot of /T. aestivum/ and /T. spelta/ volume
#+NAME: fig:ploidyvolspelt
#+ATTR_LATEX: :width 8cm
[[./images/results/group3/volume.png]]
