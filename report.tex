...
\label{sec:org7815a71}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org8db9df4} and are as follows:
...
The individual images in figure:\ref{fig:orgfc2fa89} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:org774cdd5} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:org774cdd5}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org8743d73} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org8743d73}
...
\caption{\label{fig:org6c02c4e}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org9f8d8d3}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org644343b}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org644343b}
CT Feedback form}
\end{figure}
...
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:org83d9002}.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/pipeline.png}
\caption{\label{fig:org83d9002}
How data is integrated with the CT Analysing Library}
\end{figure}

\section{Image Analysis Methods}
\label{sec:org5727f2a}
...
\end{minted}
\caption{\label{org27942aa}
CT Data Object Initialisation Method}
\end{listing}

\clearpage
\subsection{Loading Data}
\label{sec:orgdbd972a}
...
\end{minted}
\caption{\label{org78bbbcf}
Cleaning Data}
\end{listing}

\clearpage
\subsection{Data Transformations (PCA)}
\label{sec:org8843fb8}
...
\end{minted}
\caption{\label{orgb11d952}
PCA Data Transform}
\end{listing}

\clearpage
\subsection{Bayesian Hypothesis Testing}
\label{sec:org65e7308}
...
\caption{\label{fig:org10291e8}
The Initial Data Loading Window for the GUI}
\end{figure}
\subsubsection{Table View}
\label{sec:org5300bdd}
...
\label{sec:orgbf53ef5}
\begin{table}[htbp]
\caption{\label{tab:org6cee367}
...
\label{sec:orgcd31eaf}

\section{Setup.py}
\label{sec:orgbf1de3c}
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1,frame=lines,linenos=true,fontfamily=dejavu]{python}
...
\label{sec:orgafe4b75}
\label{org5d8ac85}

\subsection{Sprint - Week 0}
\label{sec:org6b8dd4a}
