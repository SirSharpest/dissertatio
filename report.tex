...
\label{sec:org965ee55}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org9474c10} and are as follows:
...
The individual images in figure:\ref{fig:org07aad7b} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
\label{sec:org1765a77}

A previous issue was highlighted in meetings of the data being ill-suited to normally accepted statistical testing and NHST in general. Through research a new method was devised that was able to use Baysian statistics to carry out hypothesis testing \cite{Kruschke2012}. This new method of hypothesis testing was added into the CT Analysing Library, requiring a lot of work in data transforming and preparation in order for correct, robust and repeatable model fitting to be carried out.
...
In figure:\ref{fig:orgde8476c} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:orgde8476c}
...
\caption{\label{fig:orga524331}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org0326820}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:orgee96ea7}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:orgee96ea7}
CT Feedback form}
\end{figure}
...
\label{sec:org47e39ea}
\section{Data Pipeline}
\label{sec:orgba76480}
...
def get_spike_info(grain_df, excel_file, join_column='Folder#'):
    ...
    return df
\end{minted}
\caption{\label{orgfae9507}
Spike Information Joining Algorithm}
\end{listing}

\section{CT GUI Application Methods}
\label{sec:org9f0ae89}
\section{Data Analysis Methods}
\label{sec:org9eafac5}

\begin{figure}[htbp]
\centering
\includegraphics[width=13cm]{./images/pipeline.png}
\caption{\label{fig:org6dfc9aa}
How data is integrated with the CT Analysing Library}
\end{figure}

\chapter{Results}
\label{sec:orge477840}
\chapter{Discussion}
\label{sec:org5b2fbb8}
\section{Similar Research}
\label{sec:org01758b2}
\section{Alternate Solutions}
\label{sec:orga75005c}
\chapter{Critical Evaluation}
\label{sec:org76bec02}
\section{Organisational Methods}
\label{sec:orgf79ae97}
\section{Relevance to Degree}
\label{sec:org76d2fae}
\section{Time Management}
\label{sec:org705f3d2}
\section{Collaborative Work}
\label{sec:org244620d}
\section{Other Issues}
\label{sec:org8523f09}
\chapter{Appendix}
\label{sec:orgd1fc0c6}
\section{\emph{Software Packages Used}}
\label{sec:orgf44fd92}

\subsection{Libraries}
\label{sec:org57435c8}
\begin{table}[htbp]
\caption{\label{tab:org06c874d}
...
\subsection{Tools}
\label{sec:org1b471af}
\begin{table}[htbp]
\caption{\label{tab:orgb5e07ac}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org65ae3b7}
\begin{table}[htbp]
\caption{\label{tab:orgd09f931}
...
\label{sec:org4254a60}
\begin{table}[htbp]
\caption{\label{tab:org3203f42}
...
\label{sec:orgc9c71ab}
\subsection{MATLAB Watershedding}
\label{sec:orgcc75ceb}
