...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:org7e2261d}).

\section{Background}
\label{sec:orgcc050a2}
...
\end{multicols}
Full species names are found in table:\ref{tab:orgf00ca1e}.

\subsection{Why use \textmu{}-CT image analysis?}
\label{sec:orgc209b85}
...
\label{sec:orgca74fdc}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org85339de} and are as follows:
...
The individual images in figure:\ref{fig:orgadbb9cc} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:org1c7336d} illustrates the range of diversity
...
These aims have a focus on the phenotypic attributes generated from customised image analysis software \cite{Hughes2017} and can be seen in figure:\ref{fig:org85339de}.


\section{Hypothesis}
\label{sec:orge8993c2}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:orgadbb9cc}.
...
In figure:\ref{fig:orgf1892bf} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:orgf1892bf}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org8cf5cc8} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org8cf5cc8}
Wire-frame of the GUI analysis window}
\end{figure}
\section{Documentation}
\label{sec:orga8cc010}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{org43f0495}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{orgc723f9f}
...
Table:\ref{tab:org0562401} contains a full listing of all software used and required by this project.
\subsection{Numpy}
\label{sec:org4470435}
...
\caption{\label{fig:org7c18dbe}
CT Analysing GUI UML}
\end{figure}

\subsection{Standards}
\label{sec:org9f51e86}
...
Additionally, \emph{setup.py} has been used to provide installation of the library, the code for this can be seen in listing:\ref{org8741837}. Using \emph{setup.py} provides a quick and easy way for any user to install the software, along with any dependencies.

\subsubsection{Issue Tracking}
\label{sec:org82051ca}
Issues were tracked during the project, both in personal notes and in the Git interface as illustrated in figure:\ref{fig:org6a15f09}
\begin{figure}[htbp]
\centering
\includegraphics[width=12cm]{./images/github.png}
\caption{\label{fig:org6a15f09}
Github Issue Tracking}
\end{figure}

\section{Library Versioning}
\label{sec:orge175756}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org4b538f4}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org4b538f4}
CT Feedback form}
\end{figure}
...
In table:\ref{tab:orgfe5bb66} the results of the automated testing is given along side an image of several of the tests, tests of the same graphs but with different parameters were also generated and manually verified and provided as supplemental data.

\begin{longtable}{|l|p{4.4cm}|C|}
\caption{\label{tab:orgfe5bb66}
...
\subsection{Tools}
\label{sec:orge212fbb}
\begin{table}[htbp]
\caption{\label{tab:orgecb2dfd}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org18ea744}
\begin{table}[htbp]
\caption{\label{tab:org7e2261d}
...
\label{sec:org3faec30}
\begin{table}[htbp]
\caption{\label{tab:orgf00ca1e}
...
\label{sec:org64caff0}
\subsection{MATLAB Watershedding}
\label{sec:orga9fdb98}
