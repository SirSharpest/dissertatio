...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:orga5fce03}).

\section{Background}
\label{sec:orgd96e73d}
...
\end{multicols}
Full species names are found in table:\ref{tab:org4d368a4}.

\subsection{Why use \textmu{}-CT image analysis?}
\label{sec:org0c86fd6}
...
\label{sec:org447947c}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org74af388} and are as follows:
...
The individual images in figure:\ref{fig:org6e9a29d} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:org0e0c1c3} illustrates the range of diversity
...
These aims have a focus on the phenotypic attributes generated from customised image analysis software \cite{Hughes2017} and can be seen in figure:\ref{fig:org74af388}.


\section{Hypothesis}
\label{sec:orgf8464a3}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:org6e9a29d}.
...
A key function of the CT Analysis Library was created, showing in listing:\ref{orgb5d16b8}. The method enables additional experiment information to be joined with extracted seed data. This provides a way of grouping seeds into more useful groupings than just their scanning data.
...
\label{sec:org339c450}
\subsection{Sprint - Week 5}
\label{sec:org7cb8674}
\subsection{Sprint - Week 6}
\label{sec:org95ad40f}
\subsection{Sprint - Week 7}
\label{sec:org4b01f6d}
\subsection{Sprint - Week 8}
\label{sec:org7c11866}
\subsection{Sprint - Week 9}
\label{sec:org6659bc9}
\subsection{Sprint - Week 10}
\label{sec:orge262ea9}
\subsection{Sprint - Week 11}
\label{sec:orgc8a10b1}
\subsection{Sprint - Week 12}
\label{sec:orga999fbe}
\subsection{Sprint - Week 13}
\label{sec:org3a7235f}
\section{Language Choices}
\label{sec:orgd026cd9}
...
In figure:\ref{fig:orgac8a09c} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:orgac8a09c}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org52abd65} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org52abd65}
Wire-frame of the GUI analysis window}
\end{figure}
\section{Documentation}
\label{sec:org1b9a8c9}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{org8fdc0b4}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org9b47aef}
...
Table:\ref{tab:org2c4a11c} contains a full listing of all software used and required by this project.
\subsection{Numpy}
\label{sec:orgf16b990}
...
\caption{\label{fig:org0e35f65}
CT Analysing GUI UML}
\end{figure}

\subsection{Standards}
\label{sec:orgb3aff65}
...
Additionally, \emph{setup.py} has been used to provide installation of the library, the code for this can be seen in listing:\ref{orge40d8cc}. Using \emph{setup.py} provides a quick and easy way for any user to install the software, along with any dependencies.

\subsubsection{Issue Tracking}
\label{sec:org1bf8dce}
Issues were tracked during the project, both in personal notes and in the Git interface as illustrated in figure:\ref{fig:org61731f6}
\begin{figure}[htbp]
\centering
\includegraphics[width=12cm]{./images/github.png}
\caption{\label{fig:org61731f6}
Github Issue Tracking}
\end{figure}
\section{Library Versioning}
\label{sec:orgc82806d}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org6b472d3}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org6b472d3}
CT Feedback form}
\end{figure}
...
In table:\ref{tab:orged45a89} the results of the automated testing is given along side an image of several of the tests, tests of the same graphs but with different parameters were also generated and manually verified and provided as supplemental data.

\begin{longtable}{|l|p{4.4cm}|C|}
\caption{\label{tab:orged45a89}
...
def get_spike_info(grain_df, excel_file, join_column='Folder#'):
    ...
    return df
\end{minted}
\caption{\label{orgb5d16b8}
Spike Information Joining Algorithm}
\end{listing}

\section{CT GUI Application Methods}
\label{sec:org76cfb2e}
\section{Data Analysis Methods}
\label{sec:org4bc8aee}

\begin{figure}[htbp]
\centering
\includegraphics[width=13cm]{./images/pipeline.png}
\caption{\label{fig:org5640f29}
How data is integrated with the CT Analysing Library}
\end{figure}

\chapter{Results}
\label{sec:org992a069}
\chapter{Discussion}
\label{sec:org6a66058}
\section{Similar Research}
\label{sec:org3339447}
\section{Alternate Solutions}
\label{sec:orgca612e0}
\chapter{Critical Evaluation}
\label{sec:org8e43c1f}
\section{Organisational Methods}
\label{sec:org75b2d66}
\section{Relevance to Degree}
\label{sec:orgf9716ee}
\section{Time Management}
\label{sec:org7db9af9}
\section{Collaborative Work}
\label{sec:org6dea1cd}
\section{Other Issues}
\label{sec:orgffe8ac6}
\chapter{Appendix}
\label{sec:org3f8ae80}
\section{\emph{Software Packages Used}}
\label{sec:orgf0447b0}

\subsection{Libraries}
\label{sec:orga539e67}
\begin{table}[htbp]
\caption{\label{tab:org2c4a11c}
...
\subsection{Tools}
\label{sec:orgb0aa520}
\begin{table}[htbp]
\caption{\label{tab:org1d0c5ba}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:orgaf4fe74}
\begin{table}[htbp]
\caption{\label{tab:orga5fce03}
...
\label{sec:orga5814b2}
\begin{table}[htbp]
\caption{\label{tab:org4d368a4}
