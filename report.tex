...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:org13be762}).

\section{Background}
\label{sec:orga247da6}
...
These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org03840f1} and are as follows:
...
The individual images in figure:\ref{fig:org8ab4de7} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:org94348c5} illustrates the range of diversity

\begin{figure}[htbp]
\centering
\includegraphics[width=11cm]{./images/spikes.png}
\caption{\label{fig:org94348c5}
...
These aims have a focus on the phenotypic attributes generated from customised image analysis software \cite{Hughes2017} and can be seen in figure:\ref{fig:org03840f1}.

\section{Hypothesis}
\label{sec:orge885a43}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:org8ab4de7}.
...
\label{sec:org0b9e371}
\begin{itemize}
\item Useable by \emph{anyone}
\end{itemize}
\section{Version control}
\label{sec:org4c95fba}
\section{Designing Process}
\label{sec:org32af4b8}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{orga2b318a}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org23fbf4b}
...
\label{sec:org4fd0138}
\section{Software Library Choices}
\label{sec:org4c118d0}
\section{Implementation}
\label{sec:org85c4e00}

\section{Testing}
\label{sec:orgebcb9cc}
\subsection{Feedback Forms}
\label{sec:orgc2c0638}
...
\label{sec:org3867bf2}
\begin{table}[htbp]
\caption{\label{tab:org895fef9}
...
\label{sec:orgd2830c6}
\begin{longtable}{|l|p{6.5cm}|C|}
\caption{\label{tab:org6b5403a}
...
\label{sec:org7e83147}
\section{Data Pipeline}
\label{sec:org2b267f7}

\begin{center}
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{./images/matlab.png}
\caption{\label{fig:org641d136}
...
\label{sec:org8719be6}
\subsection{New Watershed Algorithm}
\label{sec:org4c9dea8}

In order to solve the problem of misidentified and joint seeds, from the primitive collection,
a  \emph{quasi-euclidean} distance transform was implemented into the analysis pipeline (figure:\ref{fig:org641d136}). This provided much better results than the previous
...
\chapter{Resultss}
\label{sec:org83d7103}
\chapter{Discussion}
\label{sec:orgdab27db}
\section{Similar Research}
\label{sec:org8e7fbf0}
\section{Alternate Solutions}
\label{sec:orgee9515c}

\chapter{Critical Evaluation}
\label{sec:org9db9eb9}
\section{Organisational Methods}
\label{sec:orgdbc0523}
\section{Relevance to Degree}
\label{sec:org17c649a}
\section{Time Management}
\label{sec:orgd12cd44}
\section{Collaborative Work}
\label{sec:orgdb60eed}
\section{Other Issues}
\label{sec:org51b16fc}

\chapter{Appendix}
\label{sec:orgaa9cad7}
\section{\emph{Software Packages Used}}
\label{sec:orgdd09f59}

\subsection{Libraries}
\label{sec:org1fe0660}
\begin{table}[htbp]
\caption{\label{tab:orga33385d}
...
\subsection{Tools}
\label{sec:orgf9c15fe}
\begin{table}[htbp]
\caption{\label{tab:org47873a8}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:orgdab76fa}
\begin{table}[htbp]
\caption{\label{tab:org13be762}
...
\label{sec:org929fdc8}
\subsection{MATLAB Watershedding}
\label{sec:org4908744}
