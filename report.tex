...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:org009c70a}).
...
\end{multicols}
Full species names are found in table:\ref{tab:org61d8ee8}.

\subsection{Why use \textmu{}-CT image analysis?}
\label{sec:org335727e}
...
\label{sec:org8db3445}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org6468bfd} and are as follows:
...
The individual images in figure:\ref{fig:orgc7fc054} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:org22d791a} illustrates the range of diversity
...
These aims have a focus on the phenotypic attributes generated from customised image analysis software \cite{Hughes2017} and can be seen in figure:\ref{fig:org6468bfd}.


\section{Hypothesis}
\label{sec:orga556514}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:orgc7fc054}.
...
In figure:\ref{fig:orgcc2bec4} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=17cm]{./images/wireframe1.png}
\caption{\label{fig:orgcc2bec4}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org5f1be15} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=17cm]{./images/wireframe2.png}
\caption{\label{fig:org5f1be15}
Wire-frame of the GUI analysis window}
\end{figure}
\section{Documentation}
\label{sec:org004a305}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{org6b2230d}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org5aa2cc6}
...
\label{sec:orga2c4a91}
\section{Implementation}
\label{sec:org4d9d36e}
\subsection{Design Patterns}
\label{sec:org5d8586c}
\subsubsection{CT Analysing Library Design Pattern}
\label{sec:orgde6124c}

\begin{figure}[htbp]
\centering
\includegraphics[width=17cm]{./images/ctdata.png}
\caption{\label{fig:org4df5f50}
CT Analysing Library UML}
\end{figure}


\subsubsection{CT GUI Application Design Pattern}
\label{sec:org2bc24f2}

\begin{figure}[htbp]
\centering
\includegraphics[width=17cm]{./images/ctgui.png}
\caption{\label{fig:org5495ccf}
CT Analysing GUI UML}
\end{figure}
\section{Version control}
\label{sec:org17a1fd0}
\section{Testing}
\label{sec:org3051a14}
\subsection{Feedback Forms}
\label{sec:orgab5cf82}
...
\label{sec:org664fe77}
\begin{table}[htbp]
\caption{\label{tab:orgc9038aa}
...
\label{sec:org0d23dc6}
\begin{longtable}{|l|p{6.5cm}|C|}
\caption{\label{tab:orgd81dda3}
...
\subsection{Tools}
\label{sec:org25a946e}
\begin{table}[htbp]
\caption{\label{tab:org67bfb8c}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org14f598f}
\begin{table}[htbp]
\caption{\label{tab:org009c70a}
...
\label{sec:orgf88d387}
\begin{table}[htbp]
\caption{\label{tab:org61d8ee8}
...
\label{sec:org4d63783}
\subsection{MATLAB Watershedding}
\label{sec:org8402e62}
