...
\label{sec:org25bb1b0}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org5220451} and are as follows:
...
The individual images in figure:\ref{fig:org94706f8} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:org2918407} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:org2918407}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org688f0a6} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org688f0a6}
...
\caption{\label{fig:org773bd00}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:orgca91359}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:orgdeff744}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:orgdeff744}
CT Feedback form}
\end{figure}
...
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:org9afc2a8}.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/pipeline.png}
\caption{\label{fig:org9afc2a8}
How data is integrated with the CT Analysing Library}
\end{figure}

\section{Image Analysis Methods}
\label{sec:org4089025}
...
\end{minted}
\caption{\label{orgdde5552}
CT Data Object Initialisation Method}
\end{listing}

\clearpage
\subsection{Loading Data}
\label{sec:org7c7ff9d}
...
\end{minted}
\caption{\label{orgf9655da}
Cleaning Data}
\end{listing}

\clearpage
\subsection{Data Transformations (PCA)}
\label{sec:org9a734cf}
...
\end{minted}
\caption{\label{org929f4df}
PCA Data Transform}
\end{listing}

\clearpage
\subsection{Bayesian Hypothesis Testing}
\label{sec:orge0a3f79}
...
\caption{\label{fig:org1be2909}
Normal\((\bar{x},2s)\)}
\end{figure}


\subsubsection{\(\sigma\) (Standard Deviation)}
\label{sec:org83e349d}
...
\label{sec:orgc95389e}

\subsection{Data Distributions}
\label{sec:org58a50a4}
...
\label{sec:orgdfb67a7}

\subsection{Data Distributions}
\label{sec:org65e4e80}
...
\label{sec:org413c7f3}

\subsection{Data Distributions}
\label{sec:orgbe8e94e}
...
\label{sec:org3d23fb5}

\subsection{Data Distributions}
\label{sec:orga43edca}
...
\subsection{Tools}
\label{sec:org197be47}
\begin{table}[htbp]
\caption{\label{tab:org2c11ae9}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:orgfdb05fc}
\begin{table}[htbp]
\caption{\label{tab:org29cae00}
...
\label{sec:org39154b6}
\begin{table}[htbp]
\caption{\label{tab:org14076c7}
...
\label{sec:orgfabd482}

\section{Setup.py}
\label{sec:org9840419}
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1]{python}
...
\label{sec:org5a153b4}
\label{org5b66821}

\subsection{Sprint - Week 0}
\label{sec:org9423f15}
