...
\label{sec:org82d574b}

These samples come from over 70 plants and provided in excess of 2000 seeds. These data form the basis for this research and testing of the software libraries created. The traits recorded are labelled in figure:\ref{fig:org35403a0} and are as follows:
...
The individual images in figure:\ref{fig:org17720b5} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:orgc9d516b} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:orgc9d516b}
Wire-frame (A) of the GUI loading data window (B)}
\end{figure}

Similarly, figure:\ref{fig:org330a5c0} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org330a5c0}
...
\caption{\label{fig:orgd8bf6fd}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:orgd5ffcae}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org5c68bc5}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org5c68bc5}
CT Feedback form}
\end{figure}
...
\text{geometry interaction} = length \times depth \times width
   \end{aligned}
 \end{align}
\myequations{Geometric interation ratio}
...
\label{sec:org046334a}

Figure:\ref{fig:org91162cd} shows in two dimensional flat images how this problem was solved. As well as what the previous method was doing to cause errors in data.
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/chess_quasi.png}
\caption{\label{fig:org91162cd}
...
\label{sec:org6cb3727}

Figure:\ref{fig:orgdd44787} shows the effects on grains in three dimensions, where the seeds which where incorrectly split have now been vastly improved, leading to an increase in result accuracy.

\begin{figure}[htbp]
\centering
\includegraphics[width=14cm]{./images/watershedfigure.png}
\caption{\label{fig:orgdd44787}
...
\end{minted}
\caption{\label{org6f7ac8d}
CT Data Object Initialisation Method}
\end{listing}

\clearpage
\subsection{Loading Data}
\label{sec:org877ec32}
...
\end{minted}
\caption{\label{org21c7663}
Cleaning Data}
\end{listing}

\clearpage
\subsection{Data Transformations (PCA)}
\label{sec:org08adf40}
...
\end{minted}
\caption{\label{org7a53da6}
PCA Data Transform}
\end{listing}

\clearpage
\subsection{Bayesian Hypothesis Testing}
\label{sec:org752d13b}
...
\caption{\label{fig:orgac8706e}
The Initial Data Loading Window for the GUI}
\end{figure}
\subsubsection{Table View}
\label{sec:org112890b}
...
\caption{\label{fig:org906e586}
Normal\((\bar{x},2s)\)}
\end{figure}


\subsubsection{\(\sigma\) (Standard Deviation)}
\label{sec:org35fb35d}
...
\begin{figure}[htbp]
  \subfloat[\label{subfig-1:length}]{%
    \includegraphics[width=0.3\textwidth]{./images/results/group8/bayes_difference_of_means_length.png}
  }
  \hfill
  \subfloat[\label{subfig-2:Width}]{%
\includegraphics[width=0.3\textwidth]{./images/results/group8/bayes_difference_of_means_width.png}
  }
  \hfill
  \subfloat[\label{subfig-2:Width}]{%
\includegraphics[width=0.3\textwidth]{./images/results/group8/bayes_difference_of_means_depth.png}
  }
...
\label{sec:orgdc49a4d}
\begin{table}[htbp]
\caption{\label{tab:orgc6b34fb}
...
\label{sec:org0e24326}

\section{Setup.py}
\label{sec:org0774c73}
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1,frame=lines,linenos=true,fontfamily=DejaVuSans]{python}
...
\label{sec:org438dca7}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group1/pairplot.png}
\label{fig:org3752aec}
\end{figure}

\clearpage
\section{\emph{T. dicoccum} and \emph{T. dicoccoides}}
\label{sec:org778b2af}

\subsection{Data Distributions}
\label{sec:org30a9df3}
...
\clearpage
\subsection{Pair Plot}
\label{sec:org54c3614}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group2/pairplot.png}
\label{fig:org7a99181}
\end{figure}

\clearpage
\section{\emph{T. spelta} and \emph{T. aestivum}}
\label{sec:orgcce445d}

\subsection{Data Distributions}
\label{sec:org8c93f67}
...
\clearpage
\subsection{Pair Plot}
\label{sec:orgdccba30}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group3/pairplot.png}
\label{fig:org0aa85f8}
\end{figure}

\clearpage
\section{\emph{T. beoticum} and \emph{T. dicoccoides}}
\label{sec:org44d5886}

\subsection{Data Distributions}
\label{sec:orgd7e42e6}
...
\clearpage
\subsection{Pair Plot}
\label{sec:org5acabac}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group4/pairplot.png}
\label{fig:orgf0097ad}
\end{figure}

\clearpage
\section{\emph{T. dicoccum} and \emph{T. durum}}
\label{sec:org50d5fd8}

\subsection{Data Distributions}
\label{sec:org16b6ce6}
...
\section{\emph{T. dicoccum} and \emph{T. aestivum}}
\label{sec:org6a3a217}

\subsection{Data Distributions}
\label{sec:orga2e275d}
...
\clearpage
\subsection{Pair Plot}
\label{sec:orgccda4c8}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group6/pairplot.png}
\label{fig:orga9aed49}
\end{figure}

\clearpage
\section{\emph{T. durum} and \emph{T. aestivum}}
\label{sec:orgbe91a63}

\subsection{Data Distributions}
\label{sec:org8b1a3f9}
...
\label{sec:org75c29fa}
\label{org1b5c772}

\subsection{Sprint - Week 0}
\label{sec:orge32fadc}
