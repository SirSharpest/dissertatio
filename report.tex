<<<<<<< HEAD
% Created 2018-04-30 Mon 22:17
=======
% Created 2018-04-28 Sat 23:48
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org3d88109}
=======
\caption{\label{fig:orgcd8014c}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org98b971a}
=======
\label{sec:orgcacbf00}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
The individual images in figure:\ref{fig:org7249c1d} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
=======
The individual images in figure:\ref{fig:org549b1f7} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org7249c1d}
=======
\caption{\label{fig:org549b1f7}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgf690194}
=======
\label{sec:org9a68db4}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org6575876}
=======
\caption{\label{fig:orgd2e789a}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orga56df7a}
=======
\label{sec:org2f197b5}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orga22bf20}
=======
\label{sec:org3dbb316}
>>>>>>> 3661eb5... Fixed docs
...
\label{sec:org750f162}
Issues were tracked during the project, both in personal notes and in the Git interface as illustrated in figure:\ref{fig:org4559525}
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{./images/github.png}
\caption{\label{fig:org4559525}
=======
Additionally, \emph{setup.py} has been used to provide installation of the library, the code for this can be seen in listing:\ref{org104cf39}. Using \emph{setup.py} provides a quick and easy way for any user to install the software, along with any dependencies.

\subsubsection{Issue Tracking}
\label{sec:org1e7e94e}
Issues were tracked during the project, both in personal notes and in the Git interface as illustrated in figure:\ref{fig:orgbd30844}
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{./images/github.png}
\caption{\label{fig:orgbd30844}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org07affe1}
=======
\caption{\label{fig:orga3e489b}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org4ade828}
=======
\label{sec:org7e76b6b}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org27a65fb}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org09f74cc}
=======
\caption{\label{fig:org89674fb}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:orgbd80435}
>>>>>>> 3661eb5... Fixed docs
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org34a5869}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org34a5869}
=======
\label{sec:org98c38df}
Testing was performed both in acceptance testing by using user feedback, the functional requirements and the ability to use the software to answer the hypothesis of the research elements of this project. Further to this, unit testing was performed to allow for automated testing as well as test-driven-development of features.
\subsection{Feedback Forms}
\label{sec:org89ff2ef}
Feedback and constructive suggestions were made by researchers at the National Plant Phenomics Centre, these were submitted via the Google forms service.
...
\begin{table}[htbp]
<<<<<<< HEAD
\caption{\label{tab:org794882e}
=======
\caption{\label{tab:orge8a118a}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orga00980f}
=======
\label{sec:org282d3cd}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
In table:\ref{tab:org809e621} the results of the automated testing is given along side an image of several of the tests, tests of the same graphs but with different parameters were also generated and manually verified and provided as supplemental data.

\begin{longtable}{|l|l|p{4.4cm}|C|}
\caption{\label{tab:org809e621}
=======
In table:\ref{tab:org3c413bf} the results of the automated testing is given along side an image of several of the tests, tests of the same graphs but with different parameters were also generated and manually verified and provided as supplemental data.

\begin{longtable}{|l|l|p{4.4cm}|C|}
\caption{\label{tab:org3c413bf}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org9e69b43}
These unit tests, alongside user tests have been used to meet the outlined functional requirements; specific tests are shown in table:\ref{tab:org98d8d82} to match them to the associated functional requirement.

\begin{longtable}{|l|l|p{14cm}|}
\caption{\label{tab:org98d8d82}
=======
\label{sec:org38e614b}
These unit tests, alongside user tests have been used to meet the outlined functional requirements; specific tests are shown in table:\ref{tab:org1eb9f80} to match them to the associated functional requirement.

\begin{longtable}{|l|l|p{14cm}|}
\caption{\label{tab:org1eb9f80}
>>>>>>> 3661eb5... Fixed docs
...
\hline
<<<<<<< HEAD
16 & 21-27 & Several tests, those shown in table:\ref{tab:org809e621} are specifically recorded visually and presented as images in order to automatically unit test that visual data is intact\\
=======
16 & 21-27 & Several tests, those shown in table:\ref{tab:org3c413bf} are specifically recorded visually and presented as images in order to automatically unit test that visual data is intact\\
>>>>>>> 3661eb5... Fixed docs
\hline
...
<<<<<<< HEAD
\label{sec:orgbc8f407}
=======
\label{sec:orge112f22}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org6607ee1}
=======
\caption{\label{fig:org52ea197}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org6760252}
=======
\label{sec:org878a292}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
Values used in statistical functions and measurements are presented as metric units, derived from \textmu{}-CT image pixel values. The equation:\ref{eq:orgf923ab1} is presented here.

\begin{align}
\label{eq:orgf923ab1}
=======
Values used in statistical functions and measurements are presented as metric units, derived from \textmu{}-CT image pixel values. The equation:\ref{eq:orgc69e4aa} is presented here.
...
Here, the pipeline presented in figure:\ref{fig:org29675db} demonstrates the process used by the CT Analysis Library, and by result the CT Analysing GUI.
=======
\label{sec:org8450a43}
The data analysis and research in this project is performed in part by automated software, the CT Analysis Library, and by human decision making as to statistical methods which need to be applied.

Here, the pipeline presented in figure:\ref{fig:orgd83edb5} demonstrates the process used by the CT Analysis Library, and by result the CT Analysing GUI.
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
An additional phenotype is created to describe the interaction between the geometric parameters; the interaction is described in equation:\ref{eq:orgae62fda}.

 \begin{align}
\label{eq:orgae62fda}
=======
An additional phenotype is created to describe the interaction between the geometric parameters; the interaction is described in equation:\ref{eq:org1078ed9}.
...
<<<<<<< HEAD
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:org29675db}.
=======
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:orgd83edb5}.
>>>>>>> 3661eb5... Fixed docs
\clearpage
\begin{figure}[htbp]
\centering
...
<<<<<<< HEAD
\caption{\label{fig:org29675db}
=======
\caption{\label{fig:orgd83edb5}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org6f38aa0}
=======
\label{sec:orgd5dc889}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org13a0476}

In order to solve the problem of misidentified and joint seeds, from the primitive collection,
a  \emph{quasi-euclidean} distance transform was implemented into the analysis pipeline (figure:\ref{fig:org6607ee1}). This provided much better results than the previous
...
\label{sec:org0a6aca4}
=======
\label{sec:orge07a097}

In order to solve the problem of misidentified and joint seeds, from the primitive collection,
a  \emph{quasi-euclidean} distance transform was implemented into the analysis pipeline (figure:\ref{fig:org52ea197}). This provided much better results than the previous
\emph{chessboard} transform which had been successful on more uniform data in previous studies \cite{Hughes2017}.

\subsubsection{Quasi-Euclidean algorithm}
\label{sec:orgbe52886}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
and enabling fast distance transforms via Rosenfeld and Pfaltz's \emph{quasi-euclidean} method stated in equation:\ref{eq:org4f4170d}.

\subsection{Implementation}
\label{sec:org892e871}

The software implementation for this was done in MATLAB \cite{MATHWORKS2017}, this meant that it could instantly and easily be inserted into the existing pipeline in the open source software which was forked and modified to add this feature. In code listing:\ref{orgbcac6da} this new algorithm, in full, is shown.
=======
and enabling fast distance transforms via Rosenfeld and Pfaltz's \emph{quasi-euclidean} method stated in equation:\ref{eq:org03603fa}.

\subsection{Implementation}
\label{sec:org611854c}

The software implementation for this was done in MATLAB \cite{MATHWORKS2017}, this meant that it could instantly and easily be inserted into the existing pipeline in the open source software which was forked and modified to add this feature. In code listing:\ref{orgf6ee9d4} this new algorithm, in full, is shown.
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{orgbcac6da}
=======
\caption{\label{orgf6ee9d4}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org5d938c6}
=======
\label{sec:orgd5bd07f}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org89076bf}

Figure:\ref{fig:org866f1c2} shows in two dimensional flat images how this problem was solved. As well as what the previous method was doing to cause errors in data.
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/chess_quasi.png}
\caption{\label{fig:org866f1c2}
=======
\label{sec:org33ce06f}

Figure:\ref{fig:org24950cc} shows in two dimensional flat images how this problem was solved. As well as what the previous method was doing to cause errors in data.
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/chess_quasi.png}
\caption{\label{fig:org24950cc}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgd7b7fae}

Figure:\ref{fig:orgda10edd} shows the effects on grains in three dimensions, where the seeds which where incorrectly split have now been vastly improved, leading to an increase in result accuracy.
=======
\label{sec:org3342090}

Figure:\ref{fig:org68b491d} shows the effects on grains in three dimensions, where the seeds which where incorrectly split have now been vastly improved, leading to an increase in result accuracy.
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:orgda10edd}
=======
\caption{\label{fig:org68b491d}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgf8fdd47}
=======
\label{sec:org24a0f52}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org0e2a3ee}
=======
\label{sec:org9889661}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{orgdb87718}
=======
\caption{\label{orgbc3d394}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org6b9eabe}
=======
\label{sec:orga499c07}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{orgae3730b}
=======
\caption{\label{orgfa860e0}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgb8f4823}
=======
\label{sec:org28bbbe3}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{orgb86ca9c}
=======
\caption{\label{orga9aff2f}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgf70e680}
=======
\label{sec:org7de80a9}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{org8bcb22b}
=======
\caption{\label{orgcef6d3c}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orga1dabb4}
=======
\label{sec:orgdbddf49}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{org3a0832d}
=======
\caption{\label{orge5ec942}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org89b3439}
=======
\label{sec:orgbd8beff}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{org3ac8db9}
=======
\caption{\label{org45a3937}
>>>>>>> 3661eb5... Fixed docs
Cleaning Data}
\end{listing}
...
<<<<<<< HEAD
\label{sec:orgb457fd6}
=======
\label{sec:orgf6e0190}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{org723e810}
=======
\caption{\label{org3dbc6b4}
>>>>>>> 3661eb5... Fixed docs
PCA Data Transform}
\end{listing}
...
<<<<<<< HEAD
\label{sec:org2207d1d}
=======
\label{sec:org727dd1d}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
This function returns a \emph{trace} object which contains all of the data generated, the data of particular interest is the "difference of means" that this method calculates and the credible interval graphs which it returns the values for, figure:\ref{fig:org5e7fc98} provides an example of such. The example provided shows the likelihood of two means of an interaction term of
=======
This function returns a \emph{trace} object which contains all of the data generated, the data of particular interest is the "difference of means" that this method calculates and the credible interval graphs which it returns the values for, figure:\ref{fig:orgd878a71} provides an example of such. The example provided shows the likelihood of two means of an interaction term of
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org5e7fc98}
=======
\caption{\label{fig:orgd878a71}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
The full model is explained later in this chapter in a much more informative manner and fully defined in terms of relevance to results of this project. Listing:\ref{org997adc2} provides the python model implemented.
=======
The full model is explained later in this chapter in a much more informative manner and fully defined in terms of relevance to results of this project. Listing:\ref{orgb803658} provides the python model implemented.
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{org997adc2}
=======
\caption{\label{orgb803658}
>>>>>>> 3661eb5... Fixed docs
...
\label{sec:org26362e4}
=======
\label{sec:orgd87ae1b}
The CT GUI Application enables a researcher to perform analysis with a high degree of automation and ease of use. Here several of the elements of software engineering behind this application and its design are explored.

\subsection{Windows}
\label{sec:org2af26c1}
The CT GUI Application uses a tabbed interface, each tab carries out a specific task. This follows Gestalt themes of making user interfaces inherently clear with grouping together functionality in specific areas.

\subsubsection{The Load Data Window}
\label{sec:org6a19176}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org58857cc}
The Initial Data Loading Window for the GUI}
\end{figure}
\subsubsection{Table View}
\label{sec:orgf68e6e6}
=======
\caption{\label{fig:org00d3589}
The Initial Data Loading Window for the GUI}
\end{figure}
\subsubsection{Table View}
\label{sec:org18958f2}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:orgdf401da}
The Table view in used in the GUI}
\end{figure}
\subsubsection{The Clean Data Window}
\label{sec:org41561ae}
=======
\caption{\label{fig:orgfd71952}
The Table view in used in the GUI}
\end{figure}
\subsubsection{The Clean Data Window}
\label{sec:orgee4c9f1}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org4885e3a}
=======
\caption{\label{fig:org83f7065}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org8a49e7f}
=======
\label{sec:orgf5fed02}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org0e59e2e}
=======
\caption{\label{fig:orgf0cb03a}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgf340add}
=======
\label{sec:org71c600b}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:orgfc18eb2}
=======
\caption{\label{fig:org6d5d50d}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org394566e}
=======
\caption{\label{fig:org84a0c62}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org9a2db15}
=======
\label{sec:org7b9e515}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{org939f571}
=======
\caption{\label{orgedf7680}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org57157db}
In example:\ref{org88ab251} lines 11,12,13 show how the UI object has individual members, each of these has a "clicked" trigger, which when triggered calls a function pointer which this controller handles.
=======
\label{sec:org44b4fb9}
In example:\ref{orgd03c2da} lines 11,12,13 show how the UI object has individual members, each of these has a "clicked" trigger, which when triggered calls a function pointer which this controller handles.
>>>>>>> 3661eb5... Fixed docs
\begin{listing}[htbp]
...
\end{minted}
<<<<<<< HEAD
\caption{\label{org88ab251}
=======
\caption{\label{orgd03c2da}
>>>>>>> 3661eb5... Fixed docs
...
One example of this is in the load data function shown in example:\ref{orge5d8201}. Here the custom exception classes are imported and used for data already loaded, as well as the loading functions itself.
=======
\label{sec:orgdae6a60}

The integration with the CT Analysis Library is frequent and spread throughout this application and functions as a key dependency for data organisation.

One example of this is in the load data function shown in example:\ref{org106913e}. Here the custom exception classes are imported and used for data already loaded, as well as the loading functions itself.
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{orge5d8201}
The load data function from the load\_data window}
\end{listing}
\subsection{Plot Window Rendering}
\label{sec:orgf33d157}
=======
\caption{\label{org106913e}
The load data function from the load\_data window}
\end{listing}
\subsection{Plot Window Rendering}
\label{sec:org9c8fd21}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{orgf106784}
=======
\caption{\label{orge5b0e61}
>>>>>>> 3661eb5... Fixed docs
...
To do this, the existing canvas window is repainted based on parameter input. Example:\ref{org925c317}
>>>>>>> 3661eb5... Fixed docs
...
\end{minted}
<<<<<<< HEAD
\caption{\label{orga3b94d1}
=======
\caption{\label{org925c317}
>>>>>>> 3661eb5... Fixed docs
...
An example of this is shown when dividing data by ploidy and comparing distributions via histograms in figure:\ref{fig:org1b67591}.
=======
\label{sec:org63f72f7}

To compare data in more than a single dimension the \emph{FacetFrid} function from the \emph{Seaborn} library is used. This provides a simple method of creating multiple plots in a single figure.

An example of this is shown when dividing data by ploidy and comparing distributions via histograms in figure:\ref{fig:org4173071}.
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org1b67591}
=======
\caption{\label{fig:org4173071}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
Example:\ref{org47b21a8} shows on lines 3,5,7 how decisions are made to best arrange the grid. Decisions are made based on the unique number of columns a grouping variable provides. As well this,  additional arguments are  used to indicate further aesthetics of the plots.
=======
Example:\ref{org789cd70} shows on lines 3,5,7 how decisions are made to best arrange the grid. Decisions are made based on the unique number of columns a grouping variable provides. As well this,  additional arguments are  used to indicate further aesthetics of the plots.
>>>>>>> 3661eb5... Fixed docs
...
\label{eq:org4e9514f}
=======
\label{sec:orgc9df39e}

Modern Bayesian interpretations use the simplified model of Bayes original theorem, equation:\ref{eq:org135a494} is the basis of the implemented model in this project. This states that: the posterior is proportional to the likelihood times the prior.
...
<<<<<<< HEAD
\label{sec:org6911ff8}
=======
\label{sec:org0146df6}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org751fa3c}
=======
\caption{\label{fig:orgde4e79b}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org9bf52e7}
=======
\label{sec:orge05388e}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org259f0b6}
=======
\caption{\label{fig:orgc4a0d8f}
>>>>>>> 3661eb5... Fixed docs
Normal\((\bar{x},2s)\)}
\end{figure}
...
<<<<<<< HEAD
\caption{\label{fig:org56a7e62}
=======
\caption{\label{fig:orgea13e53}
>>>>>>> 3661eb5... Fixed docs
Uniform(1,10000)}
\end{figure}
...
Figure:\ref{fig:org8f36c11} provides the simulated data in the form of a histogram where two groups, 'g1' and 'g2' have been used. These are considered the input for the model priors.
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./images/exampledata.png}
\caption{\label{fig:org8f36c11}
=======
\label{sec:org48048c2}
A worked example is provided to demonstrate the power of this model.
\subsubsection{Input Data}
\label{sec:org50ddf21}
Given 20 data points of a simulated set of seed/grain lengths, it is generally not enough information to get a significant result from a T-Test. The data is sparse and not informative.

Figure:\ref{fig:orga70cc43} provides the simulated data in the form of a histogram where two groups, 'g1' and 'g2' have been used. These are considered the input for the model priors.
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./images/exampledata.png}
\caption{\label{fig:orga70cc43}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org3e2c5a3}
By applying the method outlined in code example:\ref{org997adc2} and defined by equation:\ref{eq:org4d0d60e} the posterior predictions can generate 1000 random samples from the perceived distributions of the data. Based on the probability of each value existing within the priors' distribution.

Figure:\ref{fig:orgec0c5f2} demonstrates the expanded data set created by the posterior predictions.
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./images/examplebayes.png}
\caption{\label{fig:orgec0c5f2}
=======
\label{sec:orgcf1fba1}
By applying the method outlined in code example:\ref{orgb803658} and defined by equation:\ref{eq:org45c0578} the posterior predictions can generate 1000 random samples from the perceived distributions of the data. Based on the probability of each value existing within the priors' distribution.

Figure:\ref{fig:orge71e545} demonstrates the expanded data set created by the posterior predictions.
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./images/examplebayes.png}
\caption{\label{fig:orge71e545}
>>>>>>> 3661eb5... Fixed docs
...
For the provided example data this model states that there is a 25.3\% chance that the two means of these groups are different. This is represented in figure:\ref{fig:org78adc42}.
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./images/examplebayes2.png}
\caption{\label{fig:org78adc42}
=======
\label{sec:org0b90e63}
Using the created data, a simple \(\mu^1 - \mu^2\) will provide the difference of group 'g1' and group 'g2' means. Which can be used to interpret the significance likelihood of the groups having different means.

For the provided example data this model states that there is a 25.3\% chance that the two means of these groups are different. This is represented in figure:\ref{fig:org289b0fd}.
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./images/examplebayes2.png}
\caption{\label{fig:org289b0fd}
>>>>>>> 3661eb5... Fixed docs
...
\chapter{Results}
<<<<<<< HEAD
\label{sec:org8f7aec8}
=======
\label{sec:org6bb9cc7}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org6f541c6}
=======
\label{sec:org11a767e}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgb03be7d}
=======
\label{sec:org283eac4}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org1425360}
=======
\label{sec:orgb929bca}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgb406510}
=======
\label{sec:orga6adbbc}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orga281eca}
=======
\label{sec:orged5b5bd}
>>>>>>> 3661eb5... Fixed docs
...
Hexaploids (\emph{T. aestivum}) when compared to tetraploids (\emph{T. dicoccum}) reports a 86.2\% chance of the two means being the same. Indicating that increasing of ploidy fron 4N to 6N does not produce a significant change in grain volume. Figure:\ref{fig:org4db2055} shows this.
=======
\label{sec:org2bd4792}

Diploids (\emph{T. beoticum}, \emph{T. monococcum}) , tetraploids (\emph{T. dicoccum}, \emph{T. dicoccoides})  show a significant difference in volume.

Hexaploids (\emph{T. aestivum}) when compared to tetraploids (\emph{T. dicoccum}) reports a 86.2\% chance of the two means being the same. Indicating that increasing of ploidy fron 4N to 6N does not produce a significant change in grain volume. Figure:\ref{fig:orgd130505} shows this.
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org4db2055}
=======
\caption{\label{fig:orgd130505}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org1011e09}
=======
\caption{\label{fig:org637153b}
>>>>>>> 3661eb5... Fixed docs
...
\chapter{Discussion}
<<<<<<< HEAD
\label{sec:orgbbf1640}
=======
\label{sec:org002cae4}
>>>>>>> 3661eb5... Fixed docs
...
A wide range of attributes which previous studies could not access \cite{Gegas2010} is made available for study. In figure:\ref{fig:org687e0e2} the available phenotypes are displayed in a pairwise fashion, demonstrating how interesting relationships between attributes could provide more information if studied further.
=======
\label{sec:org74dac32}
In plant science \textmu{}-CT and other imaging techniques have been used to great effect \cite{Hubeau2015,Staedler2013,Metzner2015}. Here this project builds upon and adds to an established image analysis tool \cite{Hughes2017} where this method was designed for drought stress experiments this project has expanded functionality for use with a wide range of genotypes.

A wide range of attributes which previous studies could not access \cite{Gegas2010} is made available for study. In figure:\ref{fig:org9e0c535} the available phenotypes are displayed in a pairwise fashion, demonstrating how interesting relationships between attributes could provide more information if studied further.
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\caption{\label{fig:org687e0e2}
=======
\caption{\label{fig:org9e0c535}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgf70d840}
=======
\label{sec:orgeb2be8c}
>>>>>>> 3661eb5... Fixed docs
...
With this data, similar solutions could be implemented. Figure:\ref{fig:org0ff42ae} shows all grains in this study, grouped by origin spike and plotted by a two component PCA. Input is calculated through averaging across spike grains' length, width, depth, volume and the geometric interaction term, via equation:\ref{eq:org1928149}.

 \begin{align}
\label{eq:org1928149}
=======
\label{sec:org291960f}
Gegas et al. previously made great use of principal component analysis with wheat mapping populations. Using PCA afforded information on grain morphology specifically towards which traits could be traced to features from ancestral species.

With this data, similar solutions could be implemented. Figure:\ref{fig:org5d4c27a} shows all grains in this study, grouped by origin spike and plotted by a two component PCA. Input is calculated through averaging across spike grains' length, width, depth, volume and the geometric interaction term, via equation:\ref{eq:org5660e23}.
...
<<<<<<< HEAD
\caption{\label{fig:org0ff42ae}
=======
\caption{\label{fig:org5d4c27a}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgd32f763}
=======
\label{sec:orgda3ae5d}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orga6a5460}
=======
\label{sec:org1c0d7a7}
>>>>>>> 3661eb5... Fixed docs
...
\label{sec:orgc7e8359}
For organisation of development the system of using weekly sprints (full diary in appendix:\ref{orgbf4de9f}) worked very well. The project being very research heavy, exploring lots of unknowns, created a lot of uncertainty. Had a waterfall methodology been used, for example, adaption to new information would have been very difficult and required a huge amount of refactoring of documentation.
=======
\label{sec:org4b5ae32}
This chapter discusses the project more critically in terms of what worked well, what helped progress, what impeded and also what the limiting factors were.

\section{Organisational Methods}
\label{sec:orgef1a9ea}
For organisation of development the system of using weekly sprints (full diary in appendix:\ref{org69fd9f6}) worked very well. The project being very research heavy, exploring lots of unknowns, created a lot of uncertainty. Had a waterfall methodology been used, for example, adaption to new information would have been very difficult and required a huge amount of refactoring of documentation.
>>>>>>> 3661eb5... Fixed docs
...
\label{sec:orgbe60c48}
=======
\label{sec:org5924587}
The project was carried out as part of completion of a BSc degree in Computer Science. It builds upon many of modules which were studied and they were also able to provide a basis of information and knowledge:

\subsection{MA35210 - Topics In Biological Statistics}
\label{sec:org76056e7}
This module provided a firm understanding of how statistics can be used in biological systems. In particular the knowledge gained from linear modelling, regression analysis and principal component analysis was incredibly useful for this project, and enhanced it greatly.
\subsection{CS31310 - Agile Methodologies}
\label{sec:orgf337b64}
The development practices used in this project are heavily inspired by the agile manifesto. Learning how to interact with clients, use SCRUM and weekly sprint techniques were pivotal to the project's progress over the course of development.
\subsection{CS34110 - Computer Vision}
\label{sec:orgfe5433a}
The computer vision module provided the basis of image analysis techniques, a set of tools and which to use to solve certain problems. Semantic segmentation techniques in particular were used extensively throughout the image analysis pipeline.
\subsection{CS36110 - Machine Learning}
\label{sec:org6ea71a5}
The data analysis model used in the research methods is heavily based on Bayesian machine learning techniques. The machine learning module provided key insight on Bayes theorem.
\subsection{CS27020 - Modelling Persistent Data}
\label{sec:org4e07e7a}
The data model used here is loosely defined to allow for change in experimental parameters, the ideas behind it come from "NoSQL" style data storage systems. Flat structures which have become incredible adaptable in terms of modelling.
\subsection{CSS0160 - Industrial year}
\label{sec:org67b208b}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgca1df99}
=======
\label{sec:org2a8629c}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org26723b7}
=======
\label{sec:orge260bfb}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org3a6a404}
=======
\label{sec:org5d564f9}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgc839f77}
=======
\label{sec:org813aade}
>>>>>>> 3661eb5... Fixed docs
...
\chapter{Glossary}
<<<<<<< HEAD
\label{sec:orgdb1e2bd}
\begin{table}[htbp]
\caption{\label{tab:org2672772}
=======
\label{sec:orgc41f6b8}
\begin{table}[htbp]
\caption{\label{tab:org9b705e3}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org6a13692}

\subsection{Libraries}
\label{sec:orgde26f90}
\begin{table}[htbp]
\caption{\label{tab:org8350686}
=======
\label{sec:orge017494}

\subsection{Libraries}
\label{sec:org98bd2d8}
\begin{table}[htbp]
\caption{\label{tab:org93bd2c8}
>>>>>>> 3661eb5... Fixed docs
...
\subsection{Tools}
<<<<<<< HEAD
\label{sec:org753fd35}
\begin{table}[htbp]
\caption{\label{tab:org1a1f8c3}
=======
\label{sec:org21a3fd0}
\begin{table}[htbp]
\caption{\label{tab:orgfa14145}
>>>>>>> 3661eb5... Fixed docs
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
...
\section{Documentation}
<<<<<<< HEAD
\label{sec:org654747c}
=======
\label{sec:org7b4c8b4}
>>>>>>> 3661eb5... Fixed docs
\clearpage
...
<<<<<<< HEAD
\label{sec:orge6497a2}
\begin{table}[htbp]
\caption{\label{tab:org6d83635}
=======
\label{sec:org7130b73}
\begin{table}[htbp]
\caption{\label{tab:org7537082}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org74aac68}

\section{Setup.py}
\label{sec:orga3f1e00}
=======
\label{sec:orgb8c6472}

\section{Setup.py}
\label{sec:orgc70fa1c}
>>>>>>> 3661eb5... Fixed docs
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1,frame=lines,linenos=true,fontfamily=DejaVuSans]{python}
...
\end{minted}
<<<<<<< HEAD
\caption{\label{orga45fb7f}
=======
\caption{\label{org104cf39}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org67e2b3c}
=======
\label{sec:org49e6088}
>>>>>>> 3661eb5... Fixed docs
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1,frame=lines,linenos=true,fontfamily=DejaVuSans]{python}
...
\end{minted}
<<<<<<< HEAD
\caption{\label{orgd41a779}
=======
\caption{\label{orgb1be250}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org8d0a9d0}
=======
\label{sec:org7e5612d}
>>>>>>> 3661eb5... Fixed docs
\begin{listing}[htbp]
...
\end{minted}
<<<<<<< HEAD
\caption{\label{org3f4602a}
=======
\caption{\label{orga446d83}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org7f7f4c0}

\section{\emph{T. monococcum} and \emph{T. beoticum}}
\label{sec:org2e67c02}
\subsection{Data Distributions}
\label{sec:orgb0fb625}
=======
\label{sec:org683b344}

\section{\emph{T. monococcum} and \emph{T. beoticum}}
\label{sec:org27b88b0}
\subsection{Data Distributions}
\label{sec:orga4ec2fb}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org8416413}
=======
\label{sec:orgeee8175}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{fig:org17228d2}
=======
\label{fig:org50519fd}
>>>>>>> 3661eb5... Fixed docs
\end{figure}
...
\section{\emph{T. dicoccum} and \emph{T. dicoccoides}}
<<<<<<< HEAD
\label{sec:org3ad914a}

\subsection{Data Distributions}
\label{sec:orge33759c}
=======
\label{sec:org9d330c9}

\subsection{Data Distributions}
\label{sec:orgb82cf59}
>>>>>>> 3661eb5... Fixed docs
...
\subsection{Pair Plot}
<<<<<<< HEAD
\label{sec:org6dc9375}
=======
\label{sec:org7cce15f}
>>>>>>> 3661eb5... Fixed docs
...
\includegraphics[width=18cm]{./images/results/group2/pairplot.png}
<<<<<<< HEAD
\label{fig:orga640a00}
=======
\label{fig:org3f6e81d}
>>>>>>> 3661eb5... Fixed docs
\end{figure}
...
\section{\emph{T. spelta} and \emph{T. aestivum}}
<<<<<<< HEAD
\label{sec:orgeac4d17}

\subsection{Data Distributions}
\label{sec:orge81dde0}
=======
\label{sec:orgb6afad1}

\subsection{Data Distributions}
\label{sec:org94c5d36}
>>>>>>> 3661eb5... Fixed docs
...
\subsection{Pair Plot}
<<<<<<< HEAD
\label{sec:org0751f6c}
=======
\label{sec:orga8116fb}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{fig:org8f8ad9c}
=======
\label{fig:org9cd3b0a}
>>>>>>> 3661eb5... Fixed docs
\end{figure}
...
\section{\emph{T. beoticum} and \emph{T. dicoccoides}}
<<<<<<< HEAD
\label{sec:orgbb50881}

\subsection{Data Distributions}
\label{sec:orgf0d4d78}
=======
\label{sec:org6c80f7c}

\subsection{Data Distributions}
\label{sec:org35800a6}
>>>>>>> 3661eb5... Fixed docs
...
\subsection{Pair Plot}
<<<<<<< HEAD
\label{sec:orgaa1f261}
=======
\label{sec:org9db96ba}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{fig:orgd2a600b}
=======
\label{fig:orga2ee28a}
>>>>>>> 3661eb5... Fixed docs
\end{figure}
...
\section{\emph{T. dicoccum} and \emph{T. durum}}
<<<<<<< HEAD
\label{sec:org859b1a5}

\subsection{Data Distributions}
\label{sec:orgea442f5}
=======
\label{sec:org067c9ab}

\subsection{Data Distributions}
\label{sec:org09e3697}
>>>>>>> 3661eb5... Fixed docs
...
\subsection{Pair Plot}
<<<<<<< HEAD
\label{sec:org5daa29b}
=======
\label{sec:org5e174b8}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{fig:orgbf9c19e}
=======
\label{fig:org83cfbe1}
>>>>>>> 3661eb5... Fixed docs
\end{figure}
...
\section{\emph{T. dicoccum} and \emph{T. aestivum}}
<<<<<<< HEAD
\label{sec:org9472f30}

\subsection{Data Distributions}
\label{sec:orgfec99ff}
=======
\label{sec:org9901f6c}

\subsection{Data Distributions}
\label{sec:org9da8c2d}
>>>>>>> 3661eb5... Fixed docs
...
\subsection{Pair Plot}
<<<<<<< HEAD
\label{sec:orgc904016}
=======
\label{sec:orgc5d361c}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{fig:orgb705c24}
=======
\label{fig:org06ec751}
>>>>>>> 3661eb5... Fixed docs
\end{figure}
...
\section{\emph{T. durum} and \emph{T. aestivum}}
<<<<<<< HEAD
\label{sec:orgddecb83}

\subsection{Data Distributions}
\label{sec:org95fd980}
=======
\label{sec:orgeaecf5d}

\subsection{Data Distributions}
\label{sec:org0be017d}
>>>>>>> 3661eb5... Fixed docs
...
\subsection{Pair Plot}
<<<<<<< HEAD
\label{sec:org6aafa0c}
=======
\label{sec:orga9357c6}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{fig:orga586c02}
=======
\label{fig:org60cf259}
>>>>>>> 3661eb5... Fixed docs
\end{figure}
...
<<<<<<< HEAD
\label{sec:org0f76c6b}
\label{orgbf4de9f}

\subsection{Sprint - Week 0}
\label{sec:orgcd7662a}
=======
\label{sec:org297a1ee}
\label{org69fd9f6}

\subsection{Sprint - Week 0}
\label{sec:orga444431}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org543bba6}
=======
\label{sec:org81cc474}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
A key function of the CT Analysis Library was created, showing in listing:\ref{orgb86ca9c}. The method enables additional experiment information to be joined with extracted seed data. This provides a way of grouping seeds into more useful groupings than just their scanning data.
=======
A key function of the CT Analysis Library was created, showing in listing:\ref{orga9aff2f}. The method enables additional experiment information to be joined with extracted seed data. This provides a way of grouping seeds into more useful groupings than just their scanning data.
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org5283b3a}
=======
\label{sec:org8e7b97d}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org0f50c88}
=======
\label{sec:org75502b7}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orgba97341}
=======
\label{sec:org0ef5b68}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org2ef829c}
=======
\label{sec:org23aa846}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:orga60a195}
=======
\label{sec:orgce38cd7}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org62fa6d0}
=======
\label{sec:org16add70}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org47a8dcb}
=======
\label{sec:org9824ccd}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org3d950c2}
=======
\label{sec:orgae1011e}
>>>>>>> 3661eb5... Fixed docs
...
<<<<<<< HEAD
\label{sec:org17fa723}
=======
\label{sec:orgd57f260}
>>>>>>> 3661eb5... Fixed docs
