...
\label{sec:org9f50028}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:orge28bbdc} and are as follows:
...
The individual images in figure:\ref{fig:orgaf87a30} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:orge63efba} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:orge63efba}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org51e5cc4} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org51e5cc4}
...
\caption{\label{fig:orgdddd64a}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org5737d48}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org36d624b}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org36d624b}
CT Feedback form}
\end{figure}
...
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:org9e6210c}.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/pipeline.png}
\caption{\label{fig:org9e6210c}
How data is integrated with the CT Analysing Library}
\end{figure}

\section{Image Analysis Methods}
\label{sec:org3c7f04a}
...
\end{minted}
\caption{\label{org5f5c23b}
CT Data Object Initialisation Method}
\end{listing}

\clearpage
\subsection{Loading Data}
\label{sec:org6a1e5a8}
...
\end{minted}
\caption{\label{orgfc7e0f1}
Cleaning Data}
\end{listing}

\clearpage
\subsection{Data Transformations (PCA)}
\label{sec:orgb38500b}
...
\end{minted}
\caption{\label{org4aeac02}
PCA Data Transform}
\end{listing}

\clearpage
\subsection{Bayesian Hypothesis Testing}
\label{sec:org23863e2}
...
\caption{\label{fig:orge7af2b3}
The Initial Data Loading Window for the GUI}
\end{figure}
\subsubsection{Table View}
\label{sec:org4b45e63}
...
\caption{\label{fig:org56ff8ac}
Normal\((\bar{x},2s)\)}
\end{figure}


\subsubsection{\(\sigma\) (Standard Deviation)}
\label{sec:orge203d14}
...
\subsection{Tools}
\label{sec:org3dcdc66}
\begin{table}[htbp]
\caption{\label{tab:orgfd5a383}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org96edefe}
\begin{table}[htbp]
\caption{\label{tab:org1465f86}
...
\label{sec:orge0c01bf}
\begin{table}[htbp]
\caption{\label{tab:org7344d22}
...
\label{sec:org8262c2a}

\section{Setup.py}
\label{sec:org7a890e6}
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1,frame=lines,linenos=true,fontfamily=dejavu]{python}
...
\label{sec:orga647a5c}
\label{orgb79dbec}

\subsection{Sprint - Week 0}
\label{sec:org3a6675f}
