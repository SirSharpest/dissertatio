...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:org2309a53}).

\section{Background}
\label{sec:org34617c8}
2
...
\end{multicols}
Full species names are found in table:\ref{tab:orgcd9d565}.

\subsection{Why use \textmu{}-CT image analysis?}
\label{sec:org9cafd13}
...
\label{sec:org99c2c42}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org4efa892} and are as follows:
...
The individual images in figure:\ref{fig:orgfbbd73a} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:org6064720} illustrates the range of diversity
...
\section{Hypothesis}
\label{sec:org3c0c140}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:orgfbbd73a}.
...
A key function of the CT Analysis Library was created, showing in listing:\ref{org4306e82}. The method enables additional experiment information to be joined with extracted seed data. This provides a way of grouping seeds into more useful groupings than just their scanning data.
...
In figure:\ref{fig:org43cabd2} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:org43cabd2}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org209f2b4} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org209f2b4}
Wire-frame of the GUI analysis window}
\end{figure}
\section{Documentation}
\label{sec:org03fa51c}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{org87f0224}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org83b6f8c}
...
Table:\ref{tab:org63fdf37} contains a full listing of all software used and required by this project.
\subsection{Numpy}
\label{sec:org5091c7e}
...
Additionally, \emph{setup.py} has been used to provide installation of the library, the code for this can be seen in listing:\ref{org1f1e66b}. Using \emph{setup.py} provides a quick and easy way for any user to install the software, along with any dependencies.

\subsubsection{Issue Tracking}
\label{sec:org9b5df52}
Issues were tracked during the project, both in personal notes and in the Git interface as illustrated in figure:\ref{fig:org43c7e0e}
\begin{figure}[htbp]
\centering
\includegraphics[width=12cm]{./images/github.png}
\caption{\label{fig:org43c7e0e}
Github Issue Tracking}
\end{figure}

\section{Implementation}
\label{sec:orga7044ed}
...
\caption{\label{fig:org8ac18fa}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org95ea2cd}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org31e84aa}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org31e84aa}
CT Feedback form}
\end{figure}
...
In table:\ref{tab:org0316c53} the results of the automated testing is given along side an image of several of the tests, tests of the same graphs but with different parameters were also generated and manually verified and provided as supplemental data.

\begin{longtable}{|l|l|p{4.4cm}|C|}
\caption{\label{tab:org0316c53}
...
\label{sec:org1c71ee0}
These unit tests, alongside user tests have been used to meet the outlined functional requirements; specific tests are shown in table:\ref{tab:org6cd884d} to match them to the associated functional requirement.

\begin{longtable}{|l|l|p{14cm}|}
\caption{\label{tab:org6cd884d}
...
\hline
16 & 21-27 & Several tests, those shown in table:\ref{tab:org0316c53} are specifically recorded visually and presented as images in order to automatically unit test that visual data is intact\\
\hline
...
The entire process is represented as a diagram in figure:\ref{fig:orgf79dabb}

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/matlab.png}
\caption{\label{fig:orgf79dabb}
Image Processing Pipeline}
\end{figure}

\subsection{Data Analysis Pipeline}
\label{sec:org2d5f295}
...
Here, the pipeline presented in figure:\ref{fig:orgb4d83cb} demonstrates the process used by the CT Analysis Library, and by result the CT Analysing GUI.
...
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:orgb4d83cb}.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/pipeline.png}
\caption{\label{fig:orgb4d83cb}
How data is integrated with the CT Analysing Library}
\end{figure}

\section{Image Analysis Methods}
\label{sec:org7556e70}
...
\label{sec:orgbccd94e}

In order to solve the problem of misidentified and joint seeds, from the primitive collection,
a  \emph{quasi-euclidean} distance transform was implemented into the analysis pipeline (figure:\ref{fig:orgf79dabb}). This provided much better results than the previous
...
and enabling fast distance transforms via Rosenfeld and Pfaltz's \emph{quasi-euclidean} method stated in equation:\ref{eq:org2bd337c}.

\subsubsection{Implementation}
\label{sec:org0ee6018}

The software implementation for this was done in MATLAB \cite{MATHWORKS2017}, this meant that it could instantly and easily be inserted into the existing pipeline in the open source software which was forked and modified to add this feature. In code listing:\ref{org006fac0} this new algorithm, in full, is shown.
...
\label{sec:orgdbf37ce}

Figure:\ref{fig:org6d3d709} shows in two dimensional flat images how this problem was solved. As well as what the previous method was doing to cause errors in data.
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/chess_quasi.png}
\caption{\label{fig:org6d3d709}
...
\label{sec:org6530856}

Figure:\ref{fig:orgc3023c2} shows the effects on grains in three dimensions, where the seeds which where incorrectly split have now been vastly improved, leading to an increase in result accuracy.

\begin{figure}[htbp]
\centering
\includegraphics[width=14cm]{./images/watershedfigure.png}
\caption{\label{fig:orgc3023c2}
...
\end{minted}
\caption{\label{orgf74e701}
CT Data Object Initialisation Method}
\end{listing}

\subsection{Loading Data}
\label{sec:orgd49aafd}
...
\end{minted}
\caption{\label{org674441f}
Loading Data Function}
\end{listing}

\subsection{Spike Rejoining}
\label{sec:org0ced053}
...
\end{minted}
\caption{\label{orge3780a2}
Cleaning Data}
\end{listing}

\subsection{Data Transformations (PCA)}
\label{sec:org629b25c}
...
\end{minted}
\caption{\label{org0be23d8}
PCA Data Transform}
\end{listing}

\subsection{Bayesian Hypothesis Testing}
\label{sec:org8077f8b}
...
Here a full model is produced where data are first normalised through power transforms, model parameters set and then 1000 simulations ran via Markov chain Monte Carlo to produce a larger data sample to perform mean testing on.
...
\subsection{Tools}
\label{sec:org1abe079}
\begin{table}[htbp]
\caption{\label{tab:org38facad}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org55ecaf0}
\begin{table}[htbp]
\caption{\label{tab:org2309a53}
...
\label{sec:org2b9f2b4}
\begin{table}[htbp]
\caption{\label{tab:orgcd9d565}
