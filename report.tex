...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:org1c83823}).

\section{Background}
\label{sec:org9edb82b}
...
\end{multicols}
/Full species names are found in table:\ref{tab:org913e8f6}.

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org8211a81} and are as follows:
...
The individual images in figure:\ref{fig:orga58baee} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:org05d0638} illustrates the range of diversity

\begin{figure}[htbp]
\centering
\includegraphics[width=13cm]{./images/spikes.png}
\caption{\label{fig:org05d0638}
...
These aims have a focus on the phenotypic attributes generated from customised image analysis software \cite{Hughes2017} and can be seen in figure:\ref{fig:org8211a81}.

\section{Hypothesis}
\label{sec:orgc9f4ac7}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:orga58baee}.
...
\label{sec:org2e8c2a5}
\begin{itemize}
\item Useable by \emph{anyone}
\end{itemize}
\section{Version control}
\label{sec:orgac9a4de}
\section{Designing Process}
\label{sec:orga5a9b0c}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{org6b59ebf}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org34a8aaf}
...
\label{sec:org856f6e3}
\section{Software Library Choices}
\label{sec:org2da29c8}
\section{Implementation}
\label{sec:org519149e}

\section{Testing}
\label{sec:org48abb6a}
\subsection{Feedback Forms}
\label{sec:org11d0276}
...
\label{sec:org3600cef}
\begin{table}[htbp]
\caption{\label{tab:org7da2ae3}
...
\label{sec:orge7d6801}
\begin{longtable}{|l|p{6.5cm}|C|}
\caption{\label{tab:org1f9f6a8}
...
and enabling fast distance transforms via Rosenfeld and Pfaltz's \emph{quasi-euclidean} method stated in equation:\ref{eq:orgea01188}.
\subsubsection{Effect of Enhanced Watershed algorithm}
\label{sec:org90bbeee}
\begin{center}
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{./images/chess_quasi.png}
\caption{\label{fig:org9a50ffd}
\emph{A} showing the chessboard method, \emph{B} improved quasi-euclidean method}
\end{figure}
\end{center}

\section{CT Analysing Library Methods}
\label{sec:org358b837}
\section{CT GUI Application Methods}
\label{sec:orgdc95143}
\section{Data Analysis Methods}
\label{sec:org3701fb7}

\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{./images/pipeline.png}
\caption{\label{fig:org4465cd6}
How data is integrated with the CT Analysing Library}
\end{figure}

\chapter{Results}
\label{sec:org46405bc}
\chapter{Discussion}
\label{sec:org0df1e4e}
\section{Similar Research}
\label{sec:org04108fa}
\section{Alternate Solutions}
\label{sec:orgdb01bbe}

\chapter{Critical Evaluation}
\label{sec:org32c00ef}
\section{Organisational Methods}
\label{sec:org425fcc5}
\section{Relevance to Degree}
\label{sec:org5329161}
\section{Time Management}
\label{sec:org4ffaf42}
\section{Collaborative Work}
\label{sec:orgcf4eb11}
\section{Other Issues}
\label{sec:orga1f3778}

\chapter{Appendix}
\label{sec:org2abaeaa}
\section{\emph{Software Packages Used}}
\label{sec:orgcff0d58}

\subsection{Libraries}
\label{sec:org367a93f}
\begin{table}[htbp]
\caption{\label{tab:orgd7040c7}
...
\subsection{Tools}
\label{sec:org2c766af}
\begin{table}[htbp]
\caption{\label{tab:org83f3964}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org4b8120b}
\begin{table}[htbp]
\caption{\label{tab:org1c83823}
...
\label{sec:orgc04e557}
\begin{table}[htbp]
\caption{\label{tab:org913e8f6}
...
\label{sec:org48245a5}
\subsection{MATLAB Watershedding}
\label{sec:orgd15d0f8}
