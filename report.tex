...
\label{sec:orgbc3d8e0}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org0a98ba8} and are as follows:
...
The individual images in figure:\ref{fig:orgf5d820a} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:org5c14c30} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:org5c14c30}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org06363c3} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org06363c3}
...
\caption{\label{fig:org3b580a7}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org6d8c7b9}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:orgb985e9c}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:orgb985e9c}
CT Feedback form}
\end{figure}
...
\label{sec:org5487382}

Figure:\ref{fig:org2393131} shows in two dimensional flat images how this problem was solved. As well as what the previous method was doing to cause errors in data.
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/chess_quasi.png}
\caption{\label{fig:org2393131}
...
\label{sec:orge2ed1ab}

Figure:\ref{fig:org6640c57} shows the effects on grains in three dimensions, where the seeds which where incorrectly split have now been vastly improved, leading to an increase in result accuracy.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/watershedfigure.png}
\caption{\label{fig:org6640c57}
...
\end{minted}
\caption{\label{org814ac29}
CT Data Object Initialisation Method}
\end{listing}

\clearpage
\subsection{Loading Data}
\label{sec:org3c6f624}
...
\end{minted}
\caption{\label{org183c560}
Cleaning Data}
\end{listing}

\clearpage
\subsection{Data Transformations (PCA)}
\label{sec:orge3c7522}
...
\end{minted}
\caption{\label{orgdea2ef5}
PCA Data Transform}
\end{listing}

\clearpage
\subsection{Bayesian Hypothesis Testing}
\label{sec:orgb4a7acc}
...
\caption{\label{fig:org30f4705}
The Initial Data Loading Window for the GUI}
\end{figure}
\subsubsection{Table View}
\label{sec:org85bd60b}
...
\caption{\label{fig:orgbd3e1a9}
Normal\((\bar{x},2s)\)}
\end{figure}


\subsubsection{\(\sigma\) (Standard Deviation)}
\label{sec:org554c57a}
...
For the provided example data this model states that there is a 25.3\% chance that the two means of these groups are different. This is represented in figure:\ref{fig:org8fc0ee4}.
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./images/examplebayes2.png}
\caption{\label{fig:org8fc0ee4}
...
\chapter{Glossary}
\label{sec:org23315b8}
\begin{table}[htbp]
\caption{\label{tab:orga90d0a5}
...
\label{sec:org3dbb16a}

\subsection{Libraries}
\label{sec:orgc5fe1c7}
\begin{table}[htbp]
\caption{\label{tab:org76c72c3}
...
\subsection{Tools}
\label{sec:orgc255f03}
\begin{table}[htbp]
\caption{\label{tab:org3ae036d}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org44cd2f0}
\begin{table}[htbp]
\caption{\label{tab:org8d33d62}
...
\label{sec:org8bbf83c}

\section{Setup.py}
\label{sec:orgc446acf}
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1,frame=lines,linenos=true,fontfamily=DejaVuSans]{python}
