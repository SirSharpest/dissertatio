...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:orgf477e52}).

\section{Background}
\label{sec:org0b17213}
2
...
\end{multicols}
Full species names are found in table:\ref{tab:org9e49d82}.

\subsection{Why use \textmu{}-CT image analysis?}
\label{sec:org94221e4}
...
\label{sec:org3ad326d}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org6153b4e} and are as follows:
...
The individual images in figure:\ref{fig:org14c33a6} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:org2552c85} illustrates the range of diversity
...
\section{Hypothesis}
\label{sec:org481c8ae}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:org14c33a6}.
...
A key function of the CT Analysis Library was created, showing in listing:\ref{org533dd0c}. The method enables additional experiment information to be joined with extracted seed data. This provides a way of grouping seeds into more useful groupings than just their scanning data.
...
In figure:\ref{fig:orgfd3c848} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:orgfd3c848}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org0d267fb} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org0d267fb}
Wire-frame of the GUI analysis window}
\end{figure}
\section{Documentation}
\label{sec:org916fcf8}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{org31dc2aa}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org70865c8}
...
Table:\ref{tab:org90b8fcd} contains a full listing of all software used and required by this project.
\subsection{Numpy}
\label{sec:orga4d5152}
...
Additionally, \emph{setup.py} has been used to provide installation of the library, the code for this can be seen in listing:\ref{org1eae5d8}. Using \emph{setup.py} provides a quick and easy way for any user to install the software, along with any dependencies.

\subsubsection{Issue Tracking}
\label{sec:org2485326}
Issues were tracked during the project, both in personal notes and in the Git interface as illustrated in figure:\ref{fig:org657e141}
\begin{figure}[htbp]
\centering
\includegraphics[width=12cm]{./images/github.png}
\caption{\label{fig:org657e141}
Github Issue Tracking}
\end{figure}

\section{Implementation}
\label{sec:orgdf39812}
...
\caption{\label{fig:org542e726}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org3189de9}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org06e037f}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org06e037f}
CT Feedback form}
\end{figure}
...
In table:\ref{tab:orgd1ae146} the results of the automated testing is given along side an image of several of the tests, tests of the same graphs but with different parameters were also generated and manually verified and provided as supplemental data.

\begin{longtable}{|l|l|p{4.4cm}|C|}
\caption{\label{tab:orgd1ae146}
...
\label{sec:org37eefe2}
These unit tests, alongside user tests have been used to meet the outlined functional requirements; specific tests are shown in table:\ref{tab:org92a34ec} to match them to the associated functional requirement.

\begin{longtable}{|l|l|p{14cm}|}
\caption{\label{tab:org92a34ec}
...
\hline
16 & 21-27 & Several tests, those shown in table:\ref{tab:orgd1ae146} are specifically recorded visually and presented as images in order to automatically unit test that visual data is intact\\
\hline
...
The entire process is represented as a diagram in figure:\ref{fig:orgcec9a37}

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/matlab.png}
\caption{\label{fig:orgcec9a37}
Image Processing Pipeline}
\end{figure}

\subsection{Data Analysis Pipeline}
\label{sec:orgdf251ee}
...
Here, the pipeline presented in figure:\ref{fig:orgdd835f6} demonstrates the process used by the CT Analysis Library, and by result the CT Analysing GUI.
...
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:orgdd835f6}.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/pipeline.png}
\caption{\label{fig:orgdd835f6}
How data is integrated with the CT Analysing Library}
\end{figure}


\section{Image Analysis Methods}
\label{sec:org11e64f1}
...
\label{sec:orge9c9260}

In order to solve the problem of misidentified and joint seeds, from the primitive collection,
a  \emph{quasi-euclidean} distance transform was implemented into the analysis pipeline (figure:\ref{fig:orgcec9a37}). This provided much better results than the previous
...
and enabling fast distance transforms via Rosenfeld and Pfaltz's \emph{quasi-euclidean} method stated in equation:\ref{eq:orgeb80dcb}.

\subsubsection{Implementation}
\label{sec:orgc951b3d}

The software implementation for this was done in MATLAB \cite{MATHWORKS2017}, this meant that it could instantly and easily be inserted into the existing pipeline in the open source software which was forked and modified to add this feature. In code listing:\ref{orgec09952} this new algorithm, in full, is shown.
...
\subsubsection{Why this algorithm works}
\label{sec:orge2fcb3d}
...
\label{sec:org89bf7c1}

Figure:\ref{fig:orgf1a2c7b} shows in two dimensional flat images how this problem was solved. As well as what the previous method was doing to cause errors in data.
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/chess_quasi.png}
\caption{\label{fig:orgf1a2c7b}
...
\label{sec:org1fe6bd9}

Figure:\ref{fig:orgbbe7b96} shows the effects on grains in three dimensions, where the seeds which where incorrectly split have now been vastly improved, leading to an increase in result accuracy.

\begin{figure}[htbp]
\centering
\includegraphics[width=14cm]{./images/watershedfigure.png}
\caption{\label{fig:orgbbe7b96}
...
\label{sec:org0a75773}
\subsection{Spike Rejoining}
\label{sec:org24d5e59}
\subsection{Data Aggregating}
\label{sec:orgf0d1c66}
\subsection{Loading Data}
\label{sec:org7173c07}
\subsection{Cleaning and Removing Erroneous Data}
\label{sec:org17602db}
\subsection{Data Transformations}
\label{sec:org5df2074}
\subsection{T-Tests}
\label{sec:orgf6a5cfe}
\subsection{Bayesian Hypothesis Testing}
\label{sec:orgca1ac0e}
\subsection{Plotting Functions}
\label{sec:orgab66087}
\subsection{Adding Spike Experiment Information}
\label{sec:orgdf3b4c7}
\begin{listing}[htbp]
\begin{minted}[]{python}
...
\subsection{Tools}
\label{sec:org33cbd52}
\begin{table}[htbp]
\caption{\label{tab:org309f763}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org6152878}
\begin{table}[htbp]
\caption{\label{tab:orgf477e52}
...
\label{sec:org06d54dc}
\begin{table}[htbp]
\caption{\label{tab:org9e49d82}
