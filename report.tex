...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:orgbda5fc8}).

\section{Background}
\label{sec:org0321ab4}
...
\end{multicols}
Full species names are found in table:\ref{tab:org1208243}.

\subsection{Why use \textmu{}-CT image analysis?}
\label{sec:orgbd125a1}
...
\label{sec:org317cb85}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:orge2216fc} and are as follows:
...
The individual images in figure:\ref{fig:orgf92747f} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:org808efe1} illustrates the range of diversity
...
These aims have a focus on the phenotypic attributes generated from customised image analysis software \cite{Hughes2017} and can be seen in figure:\ref{fig:orge2216fc}.


\section{Hypothesis}
\label{sec:orgfbac780}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:orgf92747f}.
...
In figure:\ref{fig:orgb3994c2} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:orgb3994c2}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org4332e16} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org4332e16}
Wire-frame of the GUI analysis window}
\end{figure}
\section{Documentation}
\label{sec:orgc2138d3}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{orgc18144a}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org6ed2ba7}
...
Table:\ref{tab:orge38b87c} contains a full listing of all software used and required by this project.
\subsection{CT Analysing Library}
\label{sec:org02fa526}
\subsubsection{Numpy}
\label{sec:orgc60260c}
...
\caption{\label{fig:org69b4f11}
CT Analysing GUI UML}
\end{figure}

\subsection{Standards}
\label{sec:org240b475}
...
Additionally, \emph{setup.py} has been used to provide installation of the library, the code for this can be seen in listing:\ref{org941f751}. Using \emph{setup.py} provides a quick and easy way for any user to install the software, along with any dependencies.

\subsubsection{Issue Tracking}
\label{sec:org159cb55}
Issues were tracked during the project, both in personal notes and in the Git interface as illustrated in figure:\ref{fig:orgf3e1eb2}
\begin{figure}[htbp]
\centering
\includegraphics[width=12cm]{./images/github.png}
\caption{\label{fig:orgf3e1eb2}
Github Issue Tracking}
\end{figure}

\section{Library Versioning}
\label{sec:orgeb959f8}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:orga6fbe52}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:orga6fbe52}
CT Feedback form}
\end{figure}
...
In table:\ref{tab:org9f51421} the results of the automated testing is given along side an image of several of the tests, tests of the same graphs but with different parameters were also generated and manually verified and provided as supplemental data.

\begin{longtable}{|l|p{4.4cm}|C|}
\caption{\label{tab:org9f51421}
...
\subsection{Tools}
\label{sec:org4a89786}
\begin{table}[htbp]
\caption{\label{tab:org24f1bec}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:orgf4c5e56}
\begin{table}[htbp]
\caption{\label{tab:orgbda5fc8}
...
\label{sec:orgb560f6d}
\begin{table}[htbp]
\caption{\label{tab:org1208243}
...
\label{sec:orgf58d929}
\subsection{MATLAB Watershedding}
\label{sec:orgcc5b2c5}
