...
\label{sec-3-2}
\subsection{Improvements to 3D imaging software}
\label{sec-3-2-1}
\subsubsection{New Watershed Algorithm}
\label{sec-3-2-1-1}
...
\begin{enumerate}
\item Quasi-Euclidean algorithm
\label{sec-3-2-1-1-1}
...
\item Effect of Enhanced Watershed algorithm
\label{sec-3-2-1-1-2}
\begin{center}
\begin{figure}[htb]
\centering
