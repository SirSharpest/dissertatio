...
\label{sec:org08abc35}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:orgd9e93c7} and are as follows:
...
The individual images in figure:\ref{fig:orgf7be07e} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:org7fb2b3f} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:org7fb2b3f}
...
\caption{\label{fig:org870de91}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:orge4d0758}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:orgb22ee60}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:orgb22ee60}
CT Feedback form}
\end{figure}
...
\label{sec:orge2b5589}
\section{Data Pipeline}
\label{sec:org16dee1b}
...
def get_spike_info(grain_df, excel_file, join_column='Folder#'):
    ...
    return df
\end{minted}
\caption{\label{org96658e4}
Spike Information Joining Algorithm}
\end{listing}

\section{CT GUI Application Methods}
\label{sec:org497de07}
\section{Data Analysis Methods}
\label{sec:org473b195}

\begin{figure}[htbp]
\centering
\includegraphics[width=13cm]{./images/pipeline.png}
\caption{\label{fig:org48e9cef}
How data is integrated with the CT Analysing Library}
\end{figure}

\chapter{Results}
\label{sec:orgddd5aea}
\chapter{Discussion}
\label{sec:orgf4a3072}
\section{Similar Research}
\label{sec:org4cdf45a}
\section{Alternate Solutions}
\label{sec:org937882c}
\chapter{Critical Evaluation}
\label{sec:org9f5d6ba}
\section{Organisational Methods}
\label{sec:org634188e}
\section{Relevance to Degree}
\label{sec:org6680527}
\section{Time Management}
\label{sec:org6fba292}
\section{Collaborative Work}
\label{sec:orgd472d8c}
\section{Other Issues}
\label{sec:org201e1c9}
\chapter{Appendix}
\label{sec:org6d47acd}
\section{\emph{Software Packages Used}}
\label{sec:orgd45f551}

\subsection{Libraries}
\label{sec:org37c8027}
\begin{table}[htbp]
\caption{\label{tab:org9006675}
...
\subsection{Tools}
\label{sec:orge032bee}
\begin{table}[htbp]
\caption{\label{tab:orgb0c24b8}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:orgb0f4bcd}
\begin{table}[htbp]
\caption{\label{tab:orgcf18a7b}
...
\label{sec:orgb0d5805}
\begin{table}[htbp]
\caption{\label{tab:orge463ef6}
...
\label{sec:org6c1f1ad}
\subsection{MATLAB Watershedding}
\label{sec:org29d6841}
