...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:orga53a33c}).

\section{Background}
\label{sec:orgded5149}
...
These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org38e12ad} and are as follows:
...
\caption{\label{fig:org38e12ad}
Wheat grain labelled (\emph{left}), wheat grain cut in half (\emph{right})}
\end{figure}

\section{Significance to Current Research}
\label{sec:org4678cdf}
...
The individual images in figure:\ref{fig:org09bbce4} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:orgf05bc69} illustrates the range of diversity

\begin{figure}[htbp]
\centering
\includegraphics[width=11cm]{./images/spikes.png}
\caption{\label{fig:orgf05bc69}
Two \textmu{}-CT scans of wheat spikes, showing diversity in Population, Compactum (6N) left, Durum right (4N)}
\end{figure}
...
These aims have a focus on the phenotypic attributes generated from customised image analysis software \cite{Hughes2017} and can be seen in figure:\ref{fig:org38e12ad}.

\section{Hypothesis}
\label{sec:orgc604ccf}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:org09bbce4}.
...
\label{sec:org89c8340}
\begin{itemize}
\item Useable by \emph{anyone}
\end{itemize}
\section{Version control}
\label{sec:orgbb58230}
\section{Designing Process}
\label{sec:org788a11f}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{orgdc8f1b8}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org5cca620}
...
\label{sec:org637a62c}
\section{Software Library Choices}
\label{sec:org331102c}
\section{Implementation}
\label{sec:orgde3d03b}

\section{Testing}
\label{sec:orgd5013c5}
\subsection{Feedback Forms}
\label{sec:orgbcb7b26}
...
\label{sec:orgae878f8}
\begin{table}[htbp]
\caption{\label{tab:orge90ace4}
...
\label{sec:orgbd163a5}
\begin{longtable}{|l|p{6.5cm}|C|}
\caption{\label{tab:org73b733e}
...
\end{center}\\
\hline
\color{ForestGreen}Passed & analysis.py:: box\_rb\_2 & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/analysis_window_box_rb_2.png}
\end{center}\\
\hline
...
\end{center}\\
\hline
\color{ForestGreen}Passed & analysis.py:: hist\_groupby\_1\_rb\_2 & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/analysis_window_hist_groupby_1_rb_2.png}
\end{center}\\
\hline
...
\end{center}\\
\hline
\color{ForestGreen}Passed & analysis.py:: hist\_rb\_2 & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/analysis_window_hist_rb_2.png}
\end{center}\\
\hline
\color{ForestGreen}Passed & analysis.py:: loads & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/analysis_window_loads.png}
\end{center}\\
\hline
...
\end{center}\\
\hline
\color{ForestGreen}Passed & hypothesis\_tests.py:: bayesg1\_att\_2 & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/hypothesis_bayestest_g1_att_2.png}
\end{center}\\
\hline
\color{ForestGreen}Passed & hypothesis\_tests.py:: bayesg2\_att\_1 & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/hypothesis_bayestest_g2_att_1.png}
\end{center}\\
\hline
\color{ForestGreen}Passed & hypothesis\_tests.py:: bayesg2\_att\_2 & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/hypothesis_bayestest_g2_att_2.png}
\end{center}\\
\hline
...
\end{center}\\
\hline
\color{ForestGreen}Passed & hypothesis\_tests.py:: tg1\_att\_2 & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/hypothesis_ttest_g1_att_2.png}
\end{center}\\
\hline
\color{ForestGreen}Passed & hypothesis\_tests.py:: tg2\_att\_1 & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/hypothesis_ttest_g2_att_1.png}
\end{center}\\
\hline
\color{ForestGreen}Passed & hypothesis\_tests.py:: tg2\_att\_2 & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/hypothesis_ttest_g2_att_2.png}
\end{center}\\
\hline
\color{ForestGreen}Passed & hypothesis\_tests.py:: loads & \begin{center}
\includegraphics[width=.9\linewidth]{./images/Screenshots/hypothesis_window_loads.png}
\end{center}\\
\hline
...
\label{sec:orgd96341e}
\section{Data Pipeline}
\label{sec:org055d31c}

\begin{center}
\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{./images/matlab.png}
\caption{\label{fig:org9001843}
Image Processing Pipeline}
\end{figure}
\begin{center}
\includegraphics[width=.9\linewidth]{./images/matlab.png}
\end{center}
\end{center}

\section{Image Analysis Methods}
\label{sec:org87a0fec}
\subsection{New Watershed Algorithm}
\label{sec:orga078029}

In order to solve the problem of misidentified and joint seeds, from the primitive collection,
a  \emph{quasi-euclidean} distance transform was implemented into the analysis pipeline (figure:\ref{fig:org9001843}). This provided much better results than the previous
...
\chapter{Resultss}
\label{sec:orgde8dbf3}
\chapter{Discussion}
\label{sec:org0890cae}
\section{Similar Research}
\label{sec:orga3b8747}
\section{Alternate Solutions}
\label{sec:org778d24d}

\chapter{Critical Evaluation}
\label{sec:org0ebd9fe}
\section{Organisational Methods}
\label{sec:orgbd06ebf}
\section{Relevance to Degree}
\label{sec:org1fb85cc}
\section{Time Management}
\label{sec:org51cb3ef}
\section{Collaborative Work}
\label{sec:org9a908ad}
\section{Other Issues}
\label{sec:org9360152}

\chapter{Appendix}
\label{sec:org05156be}
\section{\emph{Software Packages Used}}
\label{sec:org111cd4e}

\subsection{Libraries}
\label{sec:org0d94b6c}
\begin{table}[htbp]
\caption{\label{tab:org898dba3}
...
\subsection{Tools}
\label{sec:orgf2613ec}
\begin{table}[htbp]
\caption{\label{tab:org0b2840f}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org992eb33}
\begin{table}[htbp]
\caption{\label{tab:orga53a33c}
...
\label{sec:org9665541}
\subsection{MATLAB Watershedding}
\label{sec:orgd8f1e30}
