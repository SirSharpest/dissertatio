...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:org8348433}).

\section{Background}
\label{sec:org27e5b64}
2
...
\end{multicols}
Full species names are found in table:\ref{tab:org1237898}.

\subsection{Why use \textmu{}-CT image analysis?}
\label{sec:org7477f8c}
...
\label{sec:org3e8abdd}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org6670faa} and are as follows:
...
The individual images in figure:\ref{fig:org2678df7} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:orgd75fa3e} illustrates the range of diversity
...
\section{Hypothesis}
\label{sec:org4142d20}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:org2678df7}.
...
A full account of the sprints, which are in part running documentation for this project, are available in appendix:\ref{orgd2ffa2b}.

\section{Language Choices}
\label{sec:orgc8c911b}
...
In figure:\ref{fig:org410b72a} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:org410b72a}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org56d272b} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org56d272b}
Wire-frame of the GUI analysis window}
\end{figure}
\section{Documentation}
\label{sec:org44ba996}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{orgd5af7fc}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org9d6d824}
...
Table:\ref{tab:org344b748} contains a full listing of all software used and required by this project.
\subsection{Numpy}
\label{sec:org13a1e91}
...
Additionally, \emph{setup.py} has been used to provide installation of the library, the code for this can be seen in listing:\ref{org09dce75}. Using \emph{setup.py} provides a quick and easy way for any user to install the software, along with any dependencies.

\subsubsection{Issue Tracking}
\label{sec:org370c1de}
Issues were tracked during the project, both in personal notes and in the Git interface as illustrated in figure:\ref{fig:org8dffd2c}
\begin{figure}[htbp]
\centering
\includegraphics[width=12cm]{./images/github.png}
\caption{\label{fig:org8dffd2c}
Github Issue Tracking}
\end{figure}

\section{Implementation}
\label{sec:orgea2251a}
...
\caption{\label{fig:orgde53706}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org4eb3f39}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org54b8138}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org54b8138}
CT Feedback form}
\end{figure}
...
In table:\ref{tab:org7107c50} the results of the automated testing is given along side an image of several of the tests, tests of the same graphs but with different parameters were also generated and manually verified and provided as supplemental data.

\begin{longtable}{|l|l|p{4.4cm}|C|}
\caption{\label{tab:org7107c50}
...
\label{sec:orgf27b281}
These unit tests, alongside user tests have been used to meet the outlined functional requirements; specific tests are shown in table:\ref{tab:orgb704ac6} to match them to the associated functional requirement.

\begin{longtable}{|l|l|p{14cm}|}
\caption{\label{tab:orgb704ac6}
...
\hline
16 & 21-27 & Several tests, those shown in table:\ref{tab:org7107c50} are specifically recorded visually and presented as images in order to automatically unit test that visual data is intact\\
\hline
...
The entire process is represented as a diagram in figure:\ref{fig:org2f66097}

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/matlab.png}
\caption{\label{fig:org2f66097}
Image Processing Pipeline}
\end{figure}

\subsection{Data Analysis Pipeline}
\label{sec:org2b7d29b}
...
Here, the pipeline presented in figure:\ref{fig:org0bbaf7d} demonstrates the process used by the CT Analysis Library, and by result the CT Analysing GUI.
...
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:org0bbaf7d}.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/pipeline.png}
\caption{\label{fig:org0bbaf7d}
How data is integrated with the CT Analysing Library}
\end{figure}

\section{Image Analysis Methods}
\label{sec:org3f5d50e}
...
\label{sec:org10f60df}

In order to solve the problem of misidentified and joint seeds, from the primitive collection,
a  \emph{quasi-euclidean} distance transform was implemented into the analysis pipeline (figure:\ref{fig:org2f66097}). This provided much better results than the previous
...
and enabling fast distance transforms via Rosenfeld and Pfaltz's \emph{quasi-euclidean} method stated in equation:\ref{eq:orgabafe25}.

\subsubsection{Implementation}
\label{sec:orgb965a67}

The software implementation for this was done in MATLAB \cite{MATHWORKS2017}, this meant that it could instantly and easily be inserted into the existing pipeline in the open source software which was forked and modified to add this feature. In code listing:\ref{org103d1fa} this new algorithm, in full, is shown.
...
\label{sec:orgc18ab7a}

Figure:\ref{fig:org4374f71} shows in two dimensional flat images how this problem was solved. As well as what the previous method was doing to cause errors in data.
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/chess_quasi.png}
\caption{\label{fig:org4374f71}
...
\label{sec:org194c48b}

Figure:\ref{fig:org56b1ce2} shows the effects on grains in three dimensions, where the seeds which where incorrectly split have now been vastly improved, leading to an increase in result accuracy.

\begin{figure}[htbp]
\centering
\includegraphics[width=14cm]{./images/watershedfigure.png}
\caption{\label{fig:org56b1ce2}
...
\end{minted}
\caption{\label{org13190e9}
CT Data Object Initialisation Method}
\end{listing}

\clearpage
\subsection{Loading Data}
\label{sec:org16374ed}
...
\end{minted}
\caption{\label{orgfcd903d}
Cleaning Data}
\end{listing}

\clearpage
\subsection{Data Transformations (PCA)}
\label{sec:orgffc9632}
...
\subsection{Tools}
\label{sec:org2950a82}
\begin{table}[htbp]
\caption{\label{tab:orgb6e8d6e}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org92a4529}
\begin{table}[htbp]
\caption{\label{tab:org8348433}
...
\label{sec:org5b99945}
\begin{table}[htbp]
\caption{\label{tab:org1237898}
...
\clearpage
\chapter{\emph{Code Segments and Examples}}
\label{sec:org944ce78}

\subsection{Setup.py}
\label{sec:org5d5576e}
\begin{listing}[htbp]
\begin{minted}[]{python}
...
\label{sec:org3550fbf}
\label{orgd2ffa2b}

\subsection{Sprint - Week 0}
\label{sec:org277a41f}
...
A key function of the CT Analysis Library was created, showing in listing:\ref{org1c70cf3}. The method enables additional experiment information to be joined with extracted seed data. This provides a way of grouping seeds into more useful groupings than just their scanning data.
