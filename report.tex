...
Additionally, as this is very much multi-disciplinary research, specific terms and definitions have been outlined in the \emph{glossary} (table:\ref{tab:org0ef0ece}).

\section{Background}
\label{sec:orgd8b91da}
...
\end{multicols}
Full species names are found in table:\ref{tab:orge6a7e34}.

\subsection{Why use \textmu{}-CT image analysis?}
\label{sec:org1a546da}
...
\label{sec:org789f0cf}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:orga6d1c42} and are as follows:
...
The individual images in figure:\ref{fig:org2402a8e} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
Novel additions have been made to existing image analysis libraries in order to make them more flexible for this project. Figure:\ref{fig:orgb2a174e} illustrates the range of diversity
...
These aims have a focus on the phenotypic attributes generated from customised image analysis software \cite{Hughes2017} and can be seen in figure:\ref{fig:orga6d1c42}.


\section{Hypothesis}
\label{sec:org35c4b1f}
To provide a full spectrum of analysis the null-hypothesis of this work is presented as investigating if there are morphometric differences in the seeds of several wheat varieties outlined in figure:\ref{fig:org2402a8e}.
...
In figure:\ref{fig:org3e016b4} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:org3e016b4}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org6953168} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org6953168}
Wire-frame of the GUI analysis window}
\end{figure}
\section{Documentation}
\label{sec:org8cce1ad}
...
This documentation generator was purpose created, implemented in LISP and provided in listing:\ref{org1b85154}.

Beyond this, inline commenting is provided for supplied software. Keeping in line with the agile development ethos the software is self-documented and self-evident. A brief example of this is shown in listing:\ref{org5b5fac8}
...
Table:\ref{tab:orga1ef287} contains a full listing of all software used and required by this project.
\subsection{CT Analysing Library}
\label{sec:org55a1902}
\subsubsection{Numpy}
\label{sec:org1d96c7e}
...
\caption{\label{fig:org0e36508}
CT Analysing GUI UML}
\end{figure}


\subsection{Standards}
\label{sec:orgb12daec}
...
Additionally, \emph{setup.py} has been used to provide installation of the library, the code for this can be seen in listing:\ref{org7b8205b}.
\section{Testing}
\label{sec:org59ed0c7}
\subsection{Feedback Forms}
\label{sec:orgd205bfe}
...
\label{sec:org40f5212}
TODO
\begin{table}[htbp]
\caption{\label{tab:org4e04795}
...
\label{sec:orgd4cda19}
TODO
\begin{longtable}{|l|p{6.5cm}|C|}
\caption{\label{tab:org9fc5059}
...
\label{sec:org2b76cd0}
\section{Data Analysis Methods}
\label{sec:org49e1964}

\begin{figure}[htbp]
\centering
\includegraphics[width=10cm]{./images/pipeline.png}
\caption{\label{fig:orgfd98c79}
How data is integrated with the CT Analysing Library}
\end{figure}

\chapter{Results}
\label{sec:orgf4c3560}
\chapter{Discussion}
\label{sec:orgbfe1273}
\section{Similar Research}
\label{sec:org3ce964c}
\section{Alternate Solutions}
\label{sec:orgf7e8713}
\chapter{Critical Evaluation}
\label{sec:orgb46288a}
\section{Organisational Methods}
\label{sec:orgc3863a7}
\section{Relevance to Degree}
\label{sec:orge49e88e}
\section{Time Management}
\label{sec:orgc15a9a4}
\section{Collaborative Work}
\label{sec:org2184786}
\section{Other Issues}
\label{sec:orgddcc68e}
\chapter{Appendix}
\label{sec:org82281b5}
\section{\emph{Software Packages Used}}
\label{sec:orgb406d72}

\subsection{Libraries}
\label{sec:org35e69b9}
\begin{table}[htbp]
\caption{\label{tab:orga1ef287}
...
\subsection{Tools}
\label{sec:org143a8ad}
\begin{table}[htbp]
\caption{\label{tab:orga4eab94}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org065516e}
\begin{table}[htbp]
\caption{\label{tab:org0ef0ece}
...
\label{sec:orgd1ad635}
\begin{table}[htbp]
\caption{\label{tab:orge6a7e34}
...
\label{sec:org0615d5e}
\subsection{MATLAB Watershedding}
\label{sec:org2d9767b}
