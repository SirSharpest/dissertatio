...
\label{sec:orgcf78e19}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org4536362} and are as follows:
...
The individual images in figure:\ref{fig:org0bfef40} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:org0e88cc7} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:org0e88cc7}
...
\caption{\label{fig:orgb9497be}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org545ad63}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org61fccb3}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org61fccb3}
CT Feedback form}
\end{figure}
...
def get_spike_info(grain_df, excel_file, join_column='Folder#'):
    ...
    return df
\end{minted}
\caption{\label{orgacf9df6}
Spike Information Joining Algorithm}
\end{listing}

\section{CT GUI Application Methods}
\label{sec:org51bf16b}
\section{Data Analysis Methods}
\label{sec:org8ed915f}

\begin{figure}[htbp]
\centering
\includegraphics[width=13cm]{./images/pipeline.png}
\caption{\label{fig:orge0a20a5}
How data is integrated with the CT Analysing Library}
\end{figure}

\chapter{Results}
\label{sec:org4a8bbb6}
\chapter{Discussion}
\label{sec:orgaaf7bb0}
\section{Similar Research}
\label{sec:org03fbfd5}
\section{Alternate Solutions}
\label{sec:orgb264bf7}
\chapter{Critical Evaluation}
\label{sec:org9a2667b}
\section{Organisational Methods}
\label{sec:orgf502ba2}
\section{Relevance to Degree}
\label{sec:org18001ee}
\section{Time Management}
\label{sec:orgc7b3142}
\section{Collaborative Work}
\label{sec:org8f724cb}
\section{Other Issues}
\label{sec:orgb020123}
\chapter{Appendix}
\label{sec:orgaf0f3c2}
\section{\emph{Software Packages Used}}
\label{sec:orgd3fe9b0}

\subsection{Libraries}
\label{sec:orgfe9f289}
\begin{table}[htbp]
\caption{\label{tab:org09ef7c1}
...
\subsection{Tools}
\label{sec:orgcdbba35}
\begin{table}[htbp]
\caption{\label{tab:org942e14d}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:orgdf88349}
\begin{table}[htbp]
\caption{\label{tab:org5994cb2}
...
\label{sec:orgbc91b45}
\begin{table}[htbp]
\caption{\label{tab:org28ce4b7}
...
\label{sec:org157d210}
\subsection{MATLAB Watershedding}
\label{sec:org7476252}
