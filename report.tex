...
\label{sec:org0d20197}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:orge50325f} and are as follows:
...
The individual images in figure:\ref{fig:orgfa92441} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:org6a7781f} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:org6a7781f}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:org3262f8a} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org3262f8a}
...
\caption{\label{fig:orge881aa8}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org2f7cfbf}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org5535f69}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org5535f69}
CT Feedback form}
\end{figure}
...
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:orgc2d0ee5}.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/pipeline.png}
\caption{\label{fig:orgc2d0ee5}
How data is integrated with the CT Analysing Library}
\end{figure}

\section{Image Analysis Methods}
\label{sec:org2f0bcae}
...
\end{minted}
\caption{\label{org36266c0}
CT Data Object Initialisation Method}
\end{listing}

\clearpage
\subsection{Loading Data}
\label{sec:orgefde522}
...
\end{minted}
\caption{\label{orgda1f68f}
Cleaning Data}
\end{listing}

\clearpage
\subsection{Data Transformations (PCA)}
\label{sec:orge8395a9}
...
\end{minted}
\caption{\label{orgefec071}
PCA Data Transform}
\end{listing}

\clearpage
\subsection{Bayesian Hypothesis Testing}
\label{sec:org163e6c9}
...
\caption{\label{fig:orgc453efd}
Normal\((\bar{x},2s)\)}
\end{figure}


\subsubsection{\(\sigma\) (Standard Deviation)}
\label{sec:org31596ef}
...
\label{sec:org6327fed}

\subsection{Data Distributions}
\label{sec:org2f2e7be}
...
\label{sec:orgd47df08}

\subsection{Data Distributions}
\label{sec:org76fd733}
...
\label{sec:org36be7fa}

\subsection{Data Distributions}
\label{sec:org475cff2}
...
\label{sec:org8a51aac}

\subsection{Data Distributions}
\label{sec:orga146e2a}
...
\subsection{Tools}
\label{sec:orgf8322c1}
\begin{table}[htbp]
\caption{\label{tab:orgb1ba260}
Software tools used}
\centering
\begin{tabularx}{\textwidth}{|X|X|X|}
\hline
...
\label{sec:org38b65b7}
\begin{table}[htbp]
\caption{\label{tab:org59a7359}
...
\label{sec:org0f9b07f}
\begin{table}[htbp]
\caption{\label{tab:orgf61b960}
...
\label{sec:orgaa7b1b9}

\section{Setup.py}
\label{sec:org9bd6adc}
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1]{python}
...
\label{sec:orgf346f9c}
\label{orgb8f9130}

\subsection{Sprint - Week 0}
\label{sec:org8099852}
