...
\label{sec:orgde04904}

These samples come from over 70 plants and provided in excess of 2000 seeds. These data form the basis for this research and testing of the software libraries created. The traits recorded are labelled in figure:\ref{fig:org9b83dfb} and are as follows:
...
The individual images in figure:\ref{fig:org343efb4} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:orgad06b53} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:orgad06b53}
Wire-frame (A) of the GUI loading data window (B)}
\end{figure}

Similarly, figure:\ref{fig:org57f0fe3} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:org57f0fe3}
...
\caption{\label{fig:orgea6d89c}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:org0e15471}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:orgba5a49f}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:orgba5a49f}
CT Feedback form}
\end{figure}
...
\label{sec:org1b1569c}

Figure:\ref{fig:org3f571b5} shows in two dimensional flat images how this problem was solved. As well as what the previous method was doing to cause errors in data.
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/chess_quasi.png}
\caption{\label{fig:org3f571b5}
...
\label{sec:org5cc9252}

Figure:\ref{fig:org28c35ec} shows the effects on grains in three dimensions, where the seeds which where incorrectly split have now been vastly improved, leading to an increase in result accuracy.

\begin{figure}[htbp]
\centering
\includegraphics[width=14cm]{./images/watershedfigure.png}
\caption{\label{fig:org28c35ec}
...
\end{minted}
\caption{\label{org4b560e3}
CT Data Object Initialisation Method}
\end{listing}

\clearpage
\subsection{Loading Data}
\label{sec:org109f6cc}
...
\end{minted}
\caption{\label{orga3d550f}
Cleaning Data}
\end{listing}

\clearpage
\subsection{Data Transformations (PCA)}
\label{sec:orgaf79a74}
...
\end{minted}
\caption{\label{orgc652e97}
PCA Data Transform}
\end{listing}

\clearpage
\subsection{Bayesian Hypothesis Testing}
\label{sec:orga3e0018}
...
\caption{\label{fig:orgfda957a}
The Initial Data Loading Window for the GUI}
\end{figure}
\subsubsection{Table View}
\label{sec:org9b5723e}
...
\caption{\label{fig:orge42f078}
Normal\((\bar{x},2s)\)}
\end{figure}


\subsubsection{\(\sigma\) (Standard Deviation)}
\label{sec:orga7fc427}
...
For the provided example data this model states that there is a 25.3\% chance that the two means of these groups are different. This is represented in figure:\ref{fig:org7818411}.
\begin{figure}[htbp]
\centering
\includegraphics[width=7cm]{./images/examplebayes2.png}
\caption{\label{fig:org7818411}
...
\chapter{Glossary}
\label{sec:orgc9591b2}
\begin{table}[htbp]
\caption{\label{tab:orgd061e2f}
...
\label{sec:orgfa247b6}

\subsection{Libraries}
\label{sec:org65ee340}
\begin{table}[htbp]
\caption{\label{tab:orga90d11f}
...
\label{sec:org0d90657}
\begin{table}[htbp]
\caption{\label{tab:orgd1195ef}
...
\label{sec:org060169d}

\section{Setup.py}
\label{sec:orgc82325c}
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1,frame=lines,linenos=true,fontfamily=DejaVuSans]{python}
...
\label{sec:orgeea70c3}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group1/pairplot.png}
\label{fig:orge9a3b5d}
\end{figure}

\clearpage
\section{\emph{T. dicoccum} and \emph{T. dicoccoides}}
\label{sec:orgd2ff661}

\subsection{Data Distributions}
\label{sec:org8f1aa1b}
...
\clearpage
\subsection{Pair Plot}
\label{sec:org786a8a9}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group2/pairplot.png}
\label{fig:orgbf9ef24}
\end{figure}

\clearpage
\section{\emph{T. spelta} and \emph{T. aestivum}}
\label{sec:orgb915228}

\subsection{Data Distributions}
\label{sec:orgc1b90c4}
...
\clearpage
\subsection{Pair Plot}
\label{sec:org0b80a7b}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group3/pairplot.png}
\label{fig:orga895dba}
\end{figure}

\clearpage
\section{\emph{T. beoticum} and \emph{T. dicoccoides}}
\label{sec:org4dcb968}

\subsection{Data Distributions}
\label{sec:org84475f6}
...
\clearpage
\subsection{Pair Plot}
\label{sec:org54e9b42}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group4/pairplot.png}
\label{fig:org366d6a8}
\end{figure}

\clearpage
\section{\emph{T. dicoccum} and \emph{T. durum}}
\label{sec:org2eb7a6e}

\subsection{Data Distributions}
\label{sec:orgf87acd5}
...
\section{\emph{T. dicoccum} and \emph{T. aestivum}}
\label{sec:orga308b7e}

\subsection{Data Distributions}
\label{sec:org9812ab9}
...
\clearpage
\subsection{Pair Plot}
\label{sec:orgd6e8fd6}

\begin{figure}[htbp]
\centering
\includegraphics[width=18cm]{./images/results/group6/pairplot.png}
\label{fig:org373eeee}
\end{figure}

\clearpage
\section{\emph{T. durum} and \emph{T. aestivum}}
\label{sec:orga411a41}

\subsection{Data Distributions}
\label{sec:org9fea6f4}
...
\label{sec:org0a114f1}
\label{org748259e}

\subsection{Sprint - Week 0}
\label{sec:org10326ed}
