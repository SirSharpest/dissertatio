...
\label{sec:org4dcbac5}

These samples come from over 70 plants and provided in excess of 2000 seeds for analysis which data was created based on. The traits recorded are labelled in figure:\ref{fig:org2ee9c6b} and are as follows:
...
The individual images in figure:\ref{fig:orgf446cd3} show, at a glance, the diversity and also the difference in the wild and cultivated (domesticated)
...
In figure:\ref{fig:orgc575b9f} an example of the wire-frames created during meetings is show (A), next to it is displayed the final look of the loading window (B).
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe1.png}
\caption{\label{fig:orgc575b9f}
Wire-frame of the GUI loading data window}
\end{figure}

Similarly, figure:\ref{fig:orgbd46ce4} provides the initial wire-frame (A) of how the analysis window could have looked and what kind of GUI elements would be required, again, next to it is the final analysis window (B)
\begin{figure}[htbp]
\centering
\includegraphics[width=16cm]{./images/wireframe2.png}
\caption{\label{fig:orgbd46ce4}
...
\caption{\label{fig:org80b4ab9}
CT Analysing GUI UML}
\end{figure}
\section{Library Versioning}
\label{sec:orge9e2a1a}
...
These provided a method of acceptance testing by those who would be using the software to help with investigating data. Page 1 of the given form is shown in figure:\ref{fig:org7ebb3d8}. This form was completed by 3 researchers at the National Plant Phenomics Centre, feedback was very positive overall.
\begin{figure}[htbp]
\centering
\includegraphics[width=7.3cm]{./images/feedbackform.png}
\caption{\label{fig:org7ebb3d8}
CT Feedback form}
\end{figure}
...
From statistical testing a final result(s) can be used to answer scientific questions on the data. The entire process is represented in figure:\ref{fig:org9b353e0}.

\begin{figure}[htbp]
\centering
\includegraphics[width=15cm]{./images/pipeline.png}
\caption{\label{fig:org9b353e0}
How data is integrated with the CT Analysing Library}
\end{figure}

\section{Image Analysis Methods}
\label{sec:orgb90e73f}
...
\end{minted}
\caption{\label{org64ae2ed}
CT Data Object Initialisation Method}
\end{listing}

\clearpage
\subsection{Loading Data}
\label{sec:org0c9f20a}
...
\end{minted}
\caption{\label{org480feb7}
Cleaning Data}
\end{listing}

\clearpage
\subsection{Data Transformations (PCA)}
\label{sec:org59a1e6d}
...
\end{minted}
\caption{\label{org4739a3e}
PCA Data Transform}
\end{listing}

\clearpage
\subsection{Bayesian Hypothesis Testing}
\label{sec:orgd1c5787}
...
\caption{\label{fig:orga4673b2}
The Initial Data Loading Window for the GUI}
\end{figure}
\subsubsection{Table View}
\label{sec:org160658f}
...
\label{sec:orge0afbac}
\begin{table}[htbp]
\caption{\label{tab:orgd58c495}
...
\label{sec:org9f54009}

\section{Setup.py}
\label{sec:orgb244f72}
\begin{listing}[htbp]
\begin{minted}[linenos,firstnumber=1,frame=lines,linenos=true,fontfamily=dejavu]{python}
...
\label{sec:orgff543d4}
\label{org6525907}

\subsection{Sprint - Week 0}
\label{sec:org3d5c35a}
